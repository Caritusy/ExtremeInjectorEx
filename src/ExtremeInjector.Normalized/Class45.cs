...
public sealed class Class45<T, U> : IEnumerator, IDictionaryEnumerator, IDisposable
{
	...
	public object Key => ienumerator_0.Current.Key;

	public object Value => ienumerator_0.Current.Value;

	public object Current => this.System_002ECollections_002EIDictionaryEnumerator_002Eget_Entry();
