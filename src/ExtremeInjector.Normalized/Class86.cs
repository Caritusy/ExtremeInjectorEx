...
public sealed class Class86 : Class85
{
	...
	public IntPtr method_0838(string string_0)
	{
		...
		while (true)
		{
			...
			case 13u:
				...
				goto IL_0075;
			case 8u:
				intPtr2 = Class171.smethod_315((Class83)this, intptr_, IntPtr.Zero);
			...
			case 7u:
				...
				continue;
			case 5u:
				intPtr3 = Class171.smethod_220(gClass, Class178.smethod_0(28220), false);
				num = 452747149;
				continue;
			case 4u:
				goto IL_01d0;
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 89u:
					...
					continue;
				case 88u:
					Class171.smethod_105((ushort)1, @class);
				...
				case 45u:
					...
					continue;
				case 44u:
					num21 = Class171.smethod_246(@class);
				...
				case 24u:
				{
					...
					Class171.smethod_280(class47_, intPtr.smethod_8(num21));
					int num22;
					int num23;
					if (Class171.smethod_434(intPtr, @class, (Class84)this) == IntPtr.Zero)
					{
						num22 = 786565798;
						num23 = 786565798;
					}
				...
				default:
					...
					Class171.smethod_420(@class, class63_, Class171.smethod_409(class63_, (long)num14, class47_));
					Class171.smethod_75(@class, Class171.smethod_216(class47_, class58_4, 0L), class63_);
					num = -961223918;
					continue;
					IL_0112:
					callingConvention_ = (CallingConvention)num13;
					num = -330139360;
					continue;
				}
				break;
