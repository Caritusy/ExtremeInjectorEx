	...
	public override IntPtr method_0BA6(string string_0)
	{
		...
		while (true)
		{
			...
			case 21u:
				break;
			case 20u:
				intPtr = Class171.smethod_335(intPtr3, this, gClass);
				goto IL_0075;
			case 19u:
			...
			case 13u:
				...
				intPtr = Class171.smethod_197(this, intPtr3, gClass);
				goto IL_0075;
			case 8u:
				intPtr2 = Class171.smethod_321(this, intptr_, IntPtr.Zero);
			...
			case 7u:
				...
				continue;
			case 5u:
				intPtr3 = Class171.smethod_225(gClass, Class178.smethod_0(28220), bool_0: false);
				num = 452747149;
				continue;
			case 4u:
				goto IL_01d0;
			...
			case 1u:
				vmethod_6(intptr_);
				throw smethod_14(Class178.smethod_0(12914));
			case 6u:
				throw smethod_13(Class178.smethod_0(28237));
			case 9u:
				throw new Exception(Class178.smethod_0(28411) + num3.ToString(Class178.smethod_0(28492)) + Class178.smethod_0(3656), Class171.smethod_213(num3, this));
			case 10u:
				throw smethod_11(smethod_10(Class178.smethod_0(28151), string_0, Class178.smethod_0(3656)));
			case 11u:
				throw smethod_12(Class178.smethod_0(12662));
			case 12u:
				throw smethod_11(Class178.smethod_0(12731));
			default:
			...
			case 23u:
				{
					vmethod_6(intptr_);
					throw smethod_15(Class178.smethod_0(28330));
				}
				IL_0075:
				intptr_2 = intPtr;
		...
		goto IL_022d;
		IL_02b7:
		num = (smethod_9(string_0) ? 1656896620 : 1886342695);
		goto IL_0232;
	}

	internal IntPtr method_24(IntPtr intptr_1, string string_0, out int int_1, out int int_2)
	{
		IntPtr intPtr = Class171.smethod_175(this, 4096L, Class124.Enum34.flag_2);
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 98u:
					...
					goto IL_005d;
				case 97u:
					Class171.smethod_286(class47_, intPtr3);
				...
				case 93u:
					...
					continue;
				case 92u:
					Class171.smethod_286(class47_, (IntPtr)1);
				...
				case 91u:
					...
					continue;
				case 90u:
					Class171.smethod_286(class47_, intPtr2);
				...
				case 83u:
					...
					continue;
				case 82u:
					Class171.smethod_52(@class, (ushort)array.Length);
				...
				case 74u:
					...
					continue;
				case 73u:
					intPtr2 = intPtr.smethod_8(Class171.smethod_252(@class));
				...
				case 72u:
					...
					continue;
				case 71u:
					array2 = smethod_18(smethod_16(), string_1);
					Class171.smethod_320(@class, array2);
				...
				case 54u:
					...
					int_2 = Class171.smethod_252(@class);
				...
				case 46u:
					Class171.smethod_36(@class, class58_3);
					Class171.smethod_52(@class, (ushort)(array2.Length - 2));
				...
				case 39u:
					...
					continue;
				case 38u:
					Class171.smethod_52(@class, (ushort)array2.Length);
					Class171.smethod_227(class47_);
				...
				case 33u:
					...
					continue;
				case 32u:
					intPtr3 = intPtr.smethod_8(Class171.smethod_252(@class));
					array = smethod_18(smethod_16(), smethod_17(string_0, Class178.smethod_0(12219)));
				...
				case 24u:
					...
					Class171.smethod_286(class47_, intPtr.smethod_8(num11));
					num = ((!(Class171.smethod_443(intPtr, @class, this) == IntPtr.Zero)) ? 313284391 : 786565798) ^ ((int)num2 * -1318042794);
					continue;
				case 23u:
				...
				case 21u:
					...
					continue;
				case 20u:
					string_1 = smethod_20(new string[8]
					{
						smethod_19(method_19().method_4()),
						Class178.smethod_0(28566),
						Class127.string_1,
						Class178.smethod_0(28566),
						Class127.string_3,
						Class178.smethod_0(28566),
						Class127.string_0,
						Class178.smethod_0(12219)
					});
				...
				case 7u:
					...
					continue;
				case 6u:
					Class171.smethod_75(@class, Class171.smethod_126(class58_2, 0L), Class49.class63_37);
					num = -454015508;
					continue;
				case 5u:
				...
				case 3u:
					...
					continue;
				case 2u:
					Class171.smethod_52(@class, (ushort)(array.Length - 2));
				...
				case 1u:
					...
					continue;
				case 0u:
					Class171.smethod_320(@class, array);
					num = (int)((num2 * 636783786) ^ 0x65692FE2);
					continue;
				case 56u:
					break;
				case 51u:
					throw smethod_14(Class178.smethod_0(28497));
				case 100u:
					throw smethod_21(Class178.smethod_0(28571));
				default:
					{
						return intPtr;
					}
					...
					IL_007b:
					class63_ = class3;
					Class171.smethod_429(@class, class63_, Class171.smethod_221(class47_, Class127.bool_7 ? class2 : class4, 0L));
					Class171.smethod_429(@class, class63_, Class171.smethod_417(class63_, num8, class47_));
					Class171.smethod_75(@class, Class171.smethod_221(class47_, class58_4, 0L), class63_);
					num = -961223918;
					continue;
					IL_0112:
