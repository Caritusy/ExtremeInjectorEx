		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 13u:
					...
					continue;
				case 12u:
					num = (((object)smethod_0(typeof(T).TypeHandle) == smethod_0(typeof(IntPtr).TypeHandle)) ? 1935894933 : 640685527) ^ ((int)num2 * -1601807039);
					continue;
				case 9u:
				...
				case 1u:
					...
					continue;
				case 0u:
					num = (((object)smethod_0(typeof(T).TypeHandle) == smethod_0(typeof(UIntPtr).TypeHandle)) ? (-1885138615) : (-1557595092)) ^ ((int)num2 * -641305757);
					continue;
				case 11u:
					break;
				case 4u:
				...
				case 5u:
					return;
				default:
					throw smethod_1(Class178.smethod_0(4473));
				case 10u:
