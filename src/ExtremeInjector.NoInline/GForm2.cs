...
public sealed class GForm2 : Form
{
	...
	public sealed class Class37
	{
		...
		{
			return smethod_2(smethod_0(object_0), smethod_1(typeof(Attribute0).TypeHandle));
		}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 0u:
					break;
				default:
					smethod_3(button_4, !smethod_2(smethod_1(smethod_0())));
	...
	{
		smethod_3(checkBox_1, !smethod_4(checkBox_2));
	}

	internal void method_3(object sender, EventArgs e)
	{
		smethod_5(new GForm1());
	...
	{
		FieldInfo[] array = ((GForm2)(object)smethod_6(typeof(InjectorScrambleOptions).TypeHandle)).method_16();
		if (smethod_7(comboBox_1) == 0)
		{
			goto IL_020c;
		}
		goto IL_027f;
		...
		while (true)
		{
			...
			case 17u:
				...
				continue;
			case 16u:
				smethod_3(button_5, bool_0: false);
				num = (int)((num2 * 1542956286) ^ 0x73245C63);
				continue;
			case 15u:
				smethod_8(array2[num3], Class12.class12_0.class14_0.injectorScrambleOptions_0, false);
				num3++;
				num = 801499988;
				continue;
			case 14u:
			{
				...
				smethod_8(fieldInfo, Class12.class12_0.class14_0.injectorScrambleOptions_0, num5 >= num4);
				num = (int)(num2 * 2094900494) ^ -779081180;
				continue;
			}
			case 13u:
				smethod_3(button_5, bool_0: true);
			...
			case 2u:
				...
				continue;
			case 1u:
				obj = smethod_11(fieldInfo, bool_0: false).FirstOrDefault((object object_0) => Class37.smethod_2(Class37.smethod_0(object_0), Class37.smethod_1(typeof(Attribute0).TypeHandle)));
				num = 2009770873;
				continue;
			case 0u:
				goto end_IL_0211;
		...
		goto IL_020c;
		IL_027f:
		num = ((smethod_7(comboBox_1) >= smethod_10(smethod_9(comboBox_1)) - 1) ? 1306111333 : 2088906825);
		goto IL_0211;
	}
	...
	{
		if (smethod_12(Class178.smethod_0(2869), Class178.smethod_0(599), MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) != DialogResult.Yes)
		{
			return;
		}
		while (true)
	...
	internal void method_11(object sender, EventArgs e)
	{
		if (!Class12.class12_0.class15_0.bool_2)
		{
			while (true)
			{
				...
				while (true)
				{
					...
					{
					case 2u:
						smethod_12(Class178.smethod_0(2930), Class178.smethod_0(599), MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
		...
		try
		{
			...
			try
			{
				Class154 @class = Class171.smethod_81(Enum39.const_0, smethod_17(openFileDialog));
				try
				{
					if (@class == null)
					{
					...
					while (true)
					{
						...
						while (true)
						{
							...
							default:
							{
								SaveFileDialog saveFileDialog = smethod_18();
								try
								{
									smethod_15(saveFileDialog, smethod_19(openFileDialog));
									while (true)
									{
										int num4 = -508795643;
										while (true)
										{
											...
											case 4u:
												...
												continue;
											case 3u:
												num4 = ((smethod_16(saveFileDialog) != DialogResult.OK) ? 1136902959 : 1959171153) ^ (int)(num2 * 1097795143);
												continue;
											case 1u:
												smethod_21(saveFileDialog, smethod_20(smethod_17(openFileDialog)));
												smethod_24(saveFileDialog, smethod_23(smethod_22(smethod_17(openFileDialog)), Class178.smethod_0(3096)));
													...
													while (true)
													{
														...
														while (true)
														{
															...
															case 0u:
																break;
															default:
																smethod_12(Class178.smethod_0(3117), Class178.smethod_0(599), MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
																return;
															}
															break;
															IL_02b8:
															Class171.smethod_367(smethod_17(saveFileDialog), gClass);
			...
			{
				smethod_12(smethod_23(Class178.smethod_0(3186), smethod_26(exception_)), Class178.smethod_0(599), MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
			}
		}
		finally
		{
	...
	{
		Class154 @class = Class171.smethod_81(Enum39.const_0, smethod_1(smethod_0()));
		try
		{
			Class131 class2 = new Class131();
			...
			try
			{
				...
				Encoding encoding_ = smethod_27();
				Class171.smethod_267(encoding_, gClass, string_);
				MemoryStream memoryStream = default(MemoryStream);
				string string_2 = default(string);
				Encoding encoding_2 = default(Encoding);
				...
				while (true)
				{
					...
					while (true)
					{
						...
						case 12u:
							...
							encoding_2 = smethod_27();
							Class171.smethod_185(encoding_2, gClass, string_2);
						...
						case 9u:
							Class12.smethod_1();
							memoryStream = smethod_29();
							num = ((int)num2 * -2079510115) ^ -970640455;
							continue;
						case 8u:
							Class171.smethod_185(encoding_2, gClass, string_2);
							string_3 = Class171.smethod_147(Class178.smethod_0(93));
							num = (int)(num2 * 1739945033) ^ -1426810306;
							continue;
						case 7u:
							smethod_31(string_3, Class171.smethod_317());
							num = (int)((num2 * 279839820) ^ 0x57E4044A);
							continue;
						case 6u:
							encoding_2 = smethod_28();
						...
						case 5u:
							...
							continue;
						case 4u:
							Class9.smethod_3(smethod_30(memoryStream), string_3, PEFileKinds.WindowApplication);
							Class171.smethod_291(string_3);
			...
			catch (Exception exception_)
			{
				while (true)
				{
					...
					while (true)
					{
						...
						break;
						IL_026a:
						smethod_12(smethod_23(Class178.smethod_0(3334), smethod_26(exception_)), Class178.smethod_0(599), MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
	...
	{
		smethod_33(colorDialog_0, Class12.class12_0.class14_0.Color_2);
		if (smethod_16(colorDialog_0) == DialogResult.OK)
		{
			goto IL_0053;
		}
		goto IL_0079;
		...
		while (true)
		{
			...
			{
			case 1u:
				Class12.class12_0.class14_0.Color_2 = smethod_34(colorDialog_0);
	...
	{
		smethod_33(colorDialog_0, Class12.class12_0.class14_0.Color_0);
		if (smethod_16(colorDialog_0) == DialogResult.OK)
		{
			goto IL_0053;
		}
		...
		while (true)
		{
			...
			{
			case 1u:
				Class12.class12_0.class14_0.Color_0 = smethod_34(colorDialog_0);
	...
	{
		smethod_33(colorDialog_0, Class12.class12_0.class14_0.Color_1);
		while (true)
		{
			int num = 1652796655;
			while (true)
			{
				...
				{
				case 2u:
					num = ((smethod_16(colorDialog_0) != DialogResult.OK) ? 660861890 : 2098480816) ^ (int)(num2 * 1727397516);
					continue;
				case 1u:
					Class12.class12_0.class14_0.Color_1 = smethod_34(colorDialog_0);
