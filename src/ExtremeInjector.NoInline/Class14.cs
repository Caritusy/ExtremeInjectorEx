...
public sealed class Class14
{
	...
	public Enum4 Enum4_0
	{
		get
		{
			if (smethod_1(smethod_0(typeof(Enum4).TypeHandle), int_0))
			{
				return (Enum4)int_0;
			}
	...
	public Color Color_2
	{
		get
		{
			return smethod_2(string_2);
		}
		set
		{
			string_2 = smethod_3(value);
		}
	}
	...
	internal static bool smethod_1(Type type_0, object object_0)
	{
		return Enum.IsDefined(type_0, object_0);
	}

	internal static Color smethod_2(string string_3)
	{
		return ColorTranslator.FromHtml(string_3);
	}

	internal static string smethod_3(Color color_0)
	{
