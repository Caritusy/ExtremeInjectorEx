...
public class Class56
{
	...
	public struct Struct10
	{
		...
		static Struct10()
		{
			byte[] array_ = new byte[9];
			smethod_1(array_, (RuntimeFieldHandle)/*OpCode not supported: LdMemberToken*/);
			byte_1 = array_;
		}
	...
	{
		IntPtr intptr_ = smethod_3(smethod_2(smethod_1(typeof(T).TypeHandle)));
		while (true)
		{
			int num = -1801068041;
			while (true)
			{
				...
				default:
				{
					U result = (U)smethod_5(intptr_, smethod_1(typeof(U).TypeHandle));
					smethod_6(intptr_);
					return result;
				}
				}
				break;
				IL_0017:
				smethod_4(gparam_0, intptr_, bool_0: false);
	...
	public Class56()
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 3u:
					struct8_ = Class171.smethod_218(this);
				...
				case 0u:
					break;
				default:
					Class171.smethod_279(this, struct8_);
					return;
				}
				break;
			}
	...
	public override bool Equals(object obj)
	{
		...
		while (true)
		{
			...
			case 3u:
				goto IL_0014;
			case 2u:
				num = ((Class171.smethod_218(@class).enum8_0 == @struct.enum8_0) ? (-1234531591) : (-860608492)) ^ (int)(num2 * 1807140430);
				continue;
			case 0u:
				goto IL_00a3;
			default:
				return @struct.uint_0 == Class171.smethod_218(@class).uint_0;
			case 4u:
				return false;
			case 6u:
				return false;
			...
			break;
			IL_0014:
			num = ((Class171.smethod_218(@class).byte_0 == @struct.byte_0) ? (-1273019657) : (-1860768839));
		}
		goto IL_000d;
		IL_00a3:
		@struct = Class171.smethod_218(this);
		num = -11293284;
		goto IL_0072;
	}
	...
	{
		Struct8 @struct = Class171.smethod_218(this);
