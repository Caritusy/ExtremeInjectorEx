...
public sealed class Class69 : List<GClass1>
{
	...
	public sealed class Class70
	{
		...
		{
			return smethod_0(gclass1_0.method_6(), string_0, StringComparison.OrdinalIgnoreCase);
		}

		internal bool method_1(GClass1 gclass1_0)
		{
			return smethod_0(gclass1_0.method_8(), string_0, StringComparison.OrdinalIgnoreCase);
		}
	...
	public GClass1 this[string string_0] => Find((GClass1 gclass1_0) => Class72.smethod_0(gclass1_0.method_8(), string_0, StringComparison.OrdinalIgnoreCase));
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 8u:
					...
					continue;
				case 7u:
					num3 = FindIndex((GClass1 gclass1_0) => Class70.smethod_0(gclass1_0.method_8(), string_1, StringComparison.OrdinalIgnoreCase));
					num = -108590644;
					continue;
				case 6u:
					string_1 = string_0;
					...
					continue;
				case 3u:
					num = (smethod_0(string_1) ? (-1151442079) : (-1550847651)) ^ ((int)num2 * -1418292516);
					continue;
				case 1u:
					num3 = FindIndex((GClass1 gclass1_0) => Class70.smethod_0(gclass1_0.method_6(), string_1, StringComparison.OrdinalIgnoreCase));
