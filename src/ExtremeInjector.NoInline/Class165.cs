	...
	internal void method_0()
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 11u:
					smethod_5(binaryWriter_0, current.method_14());
				...
				case 10u:
					...
					continue;
				case 9u:
					smethod_5(binaryWriter_0, current.method_16());
					num = ((int)num2 * -1700207910) ^ 0x3B3541DF;
					continue;
				case 8u:
					smethod_4(binaryWriter_0, current.method_6());
					smethod_4(binaryWriter_0, current.method_8());
					num = (int)(num2 * 789628138) ^ -694170929;
					continue;
				case 7u:
					current = enumerator.Current;
					smethod_3(binaryWriter_0, smethod_2(smethod_0(), smethod_1(current.method_0(), 8, '\0')));
					num = -965724235;
					continue;
				case 6u:
					smethod_4(binaryWriter_0, (uint)current.method_18());
					num = (int)(num2 * 36254102) ^ -1542949198;
					continue;
				case 3u:
					smethod_4(binaryWriter_0, current.method_12());
					num = (int)(num2 * 425567313) ^ -197825505;
					continue;
				case 2u:
					smethod_4(binaryWriter_0, current.method_2());
					num = (int)((num2 * 451750893) ^ 0x3E17D33C);
					continue;
				case 1u:
					smethod_4(binaryWriter_0, current.method_4());
					num = (int)((num2 * 1386163833) ^ 0x6951C04A);
					continue;
				case 0u:
					smethod_4(binaryWriter_0, current.method_10());
