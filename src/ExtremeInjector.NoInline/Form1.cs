...
public sealed class Form1 : Form
{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 5u:
					...
					continue;
				case 4u:
					smethod_6(label_0, smethod_5(smethod_3(version_), Class178.smethod_0(952), smethod_4(version_)));
					num = (int)(num2 * 559403448) ^ -60541410;
					continue;
				case 2u:
				{
					Label control_ = label_0;
					smethod_6(control_, smethod_5(smethod_8(control_), Class178.smethod_0(952), smethod_7(version_)));
					num = ((int)num2 * -1654178938) ^ 0x3DC30A5E;
					continue;
				}
				case 1u:
					version_ = smethod_2(smethod_1(smethod_0()));
					num = ((int)num2 * -416800423) ^ -1926742095;
					continue;
				case 0u:
					num = ((smethod_7(version_) != 0) ? (-1753893004) : (-287880601)) ^ (int)(num2 * 411989617);
					continue;
				default:
					return;
				case 3u:
	...
	{
		smethod_9(Class178.smethod_0(957));
	}
