...
public sealed class Class66 : TypeConverter
{
	public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType)
	{
		if (!new Type[14]
		{
			smethod_0(typeof(IntPtr).TypeHandle),
			smethod_0(typeof(UIntPtr).TypeHandle),
			smethod_0(typeof(int).TypeHandle),
			smethod_0(typeof(uint).TypeHandle),
			smethod_0(typeof(long).TypeHandle),
			smethod_0(typeof(ulong).TypeHandle),
			smethod_0(typeof(ushort).TypeHandle),
			smethod_0(typeof(short).TypeHandle),
			smethod_0(typeof(float).TypeHandle),
			smethod_0(typeof(double).TypeHandle),
			smethod_0(typeof(bool).TypeHandle),
			smethod_0(typeof(byte).TypeHandle),
			smethod_0(typeof(sbyte).TypeHandle),
			smethod_0(typeof(Class57).TypeHandle)
		}.Contains(sourceType))
		{
