...
public sealed class Class89(GClass2 gclass2_1) : Class85(gclass2_1)
{
	...
	public override IntPtr method_0BA6(string string_0)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 3u:
					num = (smethod_8(string_0) ? 1136735320 : 1076402313) ^ ((int)num2 * -619153625);
					continue;
				case 0u:
					string_0 = smethod_9(string_0);
	...
	internal IntPtr method_36(string string_0, Enum44 enum44_0)
	{
		...
		while (true)
		{
			...
			case 4u:
				Class171.smethod_259(this);
				throw smethod_13(Class178.smethod_0(12662));
			case 6u:
				throw smethod_12(smethod_11(Class178.smethod_0(28151), string_0, Class178.smethod_0(3656)));
			case 7u:
				return IntPtr.Zero;
			default:
			{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 13u:
					...
					continue;
				case 12u:
					intPtr = Class171.smethod_225(gClass, Class178.smethod_0(29026), bool_0: false);
					num = 1163373165;
					continue;
				case 11u:
					intPtr2 = Class171.smethod_225(gClass, Class178.smethod_0(29067), bool_0: false);
					class2 = new Class53();
				...
				case 6u:
					{
						return Class171.smethod_128(this, smethod_12(Class178.smethod_0(12731)));
					}
					IL_03c6:
					...
					while (true)
					{
						...
						case 4u:
							goto IL_05cc;
						case 5u:
							return Class171.smethod_128(this, smethod_14(Class178.smethod_0(29108)));
						default:
							return true;
						}
						break;
	...
	internal IntPtr method_38(string string_0, Enum44 enum44_0)
	{
		...
		@class.method_7(smethod_15(string_0));
	...
	internal bool method_40()
	{
		...
		while (true)
		{
			...
			{
			case 30u:
				num = ((!Class171.smethod_340(Class178.smethod_0(29350), 0, byte_)) ? (-95892414) : (-469689408)) ^ (int)(num2 * 1775755729);
				continue;
			case 29u:
				num = ((!(intPtr == IntPtr.Zero)) ? 790992114 : 695052357) ^ (int)(num2 * 466392648);
				continue;
			case 27u:
				byte_ = method_10<byte>(intPtr, 300);
				num = -1539153528;
				continue;
			case 26u:
				break;
			case 25u:
				num = (((num3 = Class171.smethod_419(byte_, Class178.smethod_0(29429), Class178.smethod_0(29438), 0)) != -1) ? (-214482323) : (-2119293287)) ^ ((int)num2 * -149492349);
				continue;
			case 23u:
			{
			...
			case 22u:
				intPtr = Class171.smethod_225(gClass, Class178.smethod_0(29169), bool_0: false);
				num = -1345636675;
				continue;
			case 21u:
				num3 = Class171.smethod_419(byte_, Class178.smethod_0(29239), Class178.smethod_0(29260), 0);
				num = ((num3 == -1) ? (-1974539873) : (-1657666647)) ^ ((int)num2 * -731399899);
				continue;
			case 20u:
				goto IL_0170;
			case 19u:
				byte_ = method_10<byte>(intptr_.smethod_8(num3), 50);
				num = -81188416;
				continue;
			case 15u:
				byte_ = method_10<byte>(intptr_, 2);
				num = (int)(num2 * 123420433) ^ -455294339;
				continue;
			case 14u:
				smethod_21(smethod_20(ushort_), 0, array2, 3, 2);
			...
			case 8u:
			{
				...
				smethod_19(array, (RuntimeFieldHandle)/*OpCode not supported: LdMemberToken*/);
				array2 = array;
				num = -237273941;
				continue;
			}
			case 5u:
				...
				continue;
			case 3u:
				ushort_ = smethod_18(byte_, num3 + 1);
				num = -78619695;
				continue;
			case 2u:
				num3 += 2;
			...
			case 10u:
				goto IL_039c;
			case 0u:
				return Class171.smethod_128(this, smethod_14(Class178.smethod_0(29512)));
			case 1u:
				return Class171.smethod_128(this, smethod_12(Class178.smethod_0(12731)));
			case 4u:
				return Class171.smethod_128(this, smethod_17(Class178.smethod_0(29443)));
			case 6u:
				return Class171.smethod_128(this, smethod_14(Class178.smethod_0(29589)));
			case 7u:
				return Class171.smethod_128(this, smethod_17(Class178.smethod_0(29359)));
			default:
				return true;
			case 16u:
				return Class171.smethod_128(this, smethod_17(Class178.smethod_0(29359)));
			...
			case 18u:
				return true;
			case 24u:
				return Class171.smethod_128(this, smethod_17(Class178.smethod_0(29277)));
			case 28u:
				return Class171.smethod_128(this, smethod_16(Class178.smethod_0(29182)));
			}
			break;
			IL_0237:
			byte_ = method_10<byte>(intptr_, 200);
			num = (((num3 = Class171.smethod_378(byte_, Class178.smethod_0(29424), 0)) == -1) ? (-1443517686) : (-1486477485));
			continue;
			IL_0170:
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 6u:
						...
						continue;
					case 5u:
						result = Class171.smethod_128(this, smethod_14(Class178.smethod_0(29678)));
	...
	internal bool method_42(Class172 class172_0, Class148 class148_0)
	{
		...
		while (true)
		{
					...
					while (true)
					{
						...
						while (true)
						{
							...
							case 7u:
								...
								continue;
							case 5u:
								result = Class171.smethod_128(this, new MissingMethodException(Class178.smethod_0(29808) + (current.method_7() ? current.method_2().ToString() : current.method_4()) + Class178.smethod_0(29853) + text));
								num4 = -1311108833;
								continue;
							case 3u:
								current = enumerator.Current;
								...
								continue;
							case 2u:
								result = Class171.smethod_128(this, new AccessViolationException(Class178.smethod_0(29882)));
			...
			case 11u:
				goto IL_036f;
			case 5u:
				return Class171.smethod_128(this, smethod_23(smethod_22(Class178.smethod_0(29755), text)));
			case 9u:
				return false;
			case 12u:
				{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 6u:
					break;
				case 0u:
					return Class171.smethod_128(this, new InvalidOperationException(Class178.smethod_0(29963) + class172_0.method_6()));
				case 1u:
					return true;
				default:
				{
							...
							while (true)
							{
								...
								while (true)
								{
									...
									case 15u:
										...
										continue;
									case 14u:
										result = Class171.smethod_128(this, new AccessViolationException(Class178.smethod_0(30068)));
									...
									case 12u:
										...
										continue;
									case 10u:
										result = Class171.smethod_128(this, new InvalidOperationException(Class178.smethod_0(30129) + current2.method_2()));
										num4 = -411687850;
										continue;
									case 9u:
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 4u:
					break;
				case 0u:
					return Class171.smethod_128(this, smethod_14(Class178.smethod_0(30255)));
				case 2u:
					return Class171.smethod_128(this, smethod_14(Class178.smethod_0(30194)));
				default:
				{
						...
						while (true)
						{
							...
							while (true)
							{
								...
								case 0u:
									goto end_IL_01d9;
								case 5u:
									return Class171.smethod_128(this, smethod_14(Class178.smethod_0(30316)));
								}
								goto IL_021a;
								continue;
								end_IL_01d9:
			...
			.GetEnumerator())
		{
			...
			while (true)
			{
				...
				if (enumerator.MoveNext())
				{
					...
					try
					{
						smethod_24(stream, array, 0, array.Length);
					}
					finally
					{
						if (stream != null)
