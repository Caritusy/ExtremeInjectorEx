	...
	public override IntPtr method_0BA6(string string_0)
	{
		...
		while (true)
		{
			...
			case 21u:
				break;
			case 20u:
				intPtr = Class171.smethod_321(this, intptr_, IntPtr.Zero);
			...
			continue;
			IL_012e:
			intPtr2 = Class171.smethod_225(Class171.smethod_42(method_19())[Class178.smethod_0(8549)] ?? throw smethod_11(Class178.smethod_0(12731)), Class178.smethod_0(28220), bool_0: false);
			num = -2108430739;
			continue;
			end_IL_0231:
			break;
		...
		goto IL_019a;
		IL_02b3:
		num = (smethod_9(string_0) ? (-181323686) : (-1843062060));
		goto IL_0231;
	}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 23u:
					...
					int_1 = Class171.smethod_252(class2);
				...
				case 21u:
					...
					continue;
				case 19u:
					Class171.smethod_75(class2, Class171.smethod_126(class58_3, 0L), Class49.class63_37);
					Class171.smethod_226(class47_, -1);
					num = 1129210671;
					continue;
				case 18u:
					Class171.smethod_286(class47_, intPtr2);
					num = ((Class171.smethod_443(intPtr, class2, this) == IntPtr.Zero) ? 1549379627 : 113368551) ^ ((int)num2 * -253945004);
					continue;
				case 17u:
					num = (Class171.smethod_427(method_19()) ? 1506205645 : 2023462491) ^ ((int)num2 * -904323616);
					continue;
				case 16u:
					...
					continue;
				case 15u:
					Class171.smethod_52(class2, (ushort)array.Length);
				...
				case 13u:
					...
					continue;
				case 12u:
					int_2 = Class171.smethod_252(class2);
					num = ((int)num2 * -853169748) ^ 0xB8B624A;
					continue;
				case 11u:
					Class171.smethod_52(class2, (ushort)(array.Length - 2));
				...
				case 9u:
					...
					continue;
				case 7u:
					intPtr2 = intPtr.smethod_8(Class171.smethod_252(class2));
				...
				case 3u:
					break;
				case 8u:
					throw smethod_14(Class178.smethod_0(28957));
				case 22u:
					throw smethod_19(Class178.smethod_0(28571));
				default:
					return intPtr;
				}
				break;
