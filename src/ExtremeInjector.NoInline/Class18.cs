	...
	internal static void Main(string[] args)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				default:
					{
						ProcessStartInfo processStartInfo = smethod_2(smethod_1(smethod_0()));
						smethod_3(processStartInfo, Class178.smethod_0(119));
						smethod_4(processStartInfo, bool_1: true);
						ProcessStartInfo processStartInfo_ = processStartInfo;
						try
						{
							smethod_5(processStartInfo_);
							smethod_6(0);
						}
						catch (Exception)
						{
