...
public class Class6 : Class5
{
		...
		: base(stream_0)
	{
		...
		@class.method_1(smethod_6(string_0));
		@class.method_3(smethod_7(string_0));
		class154_0 = @class;
	}
	...
	{
		long long_ = smethod_9(smethod_8(this));
		...
		smethod_10(smethod_8(this), long_);
		num = -1185471087;
		goto IL_00fb;
	}
	...
	{
		T val = (T)smethod_12(smethod_11(typeof(T).TypeHandle), BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, new object[3] { stream_0, bool_0, enum39_0 }, null);
		while (true)
		{
			int num = 411043789;
			while (true)
	...
	{
		T val = (T)smethod_12(smethod_11(typeof(T).TypeHandle), BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, new object[4] { stream_0, string_0, bool_0, enum39_0 }, null);
		while (true)
		{
			int num = 1617372357;
			while (true)
