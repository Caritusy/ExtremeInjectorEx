...
public sealed class GClass1
{
	...
	internal IntPtr method_14(object object_0, bool bool_2)
	{
		...
		while (true)
		{
			...
			{
			case 3u:
				num3 = ((Class171.smethod_131(this).Count == 0) ? (-1523013849) : (-1056748293)) ^ ((int)num2 * -393997819);
				continue;
			case 0u:
				break;
			case 2u:
				...
				while (true)
				{
					...
					while (true)
					{
						...
						case 8u:
							...
							continue;
						case 7u:
							num6 = ((!smethod_0(current.Key.method_6(), method_6())) ? (-1084369159) : (-358944230)) ^ (int)(num2 * 1081615982);
							continue;
						case 6u:
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 29u:
						...
						continue;
					case 28u:
						result = Class171.smethod_225(gClass, current2.method_8().method_6(), bool_0: false);
						num7 = 228034350;
						continue;
					case 26u:
					...
					case 25u:
						...
						continue;
					case 23u:
						num7 = ((!smethod_1(current2.method_4(), string_)) ? (-817980784) : (-863804854)) ^ ((int)num2 * -1155092747);
						continue;
					case 22u:
					...
					case 19u:
						...
						intPtr = Class171.smethod_225(gClass, current2.method_8().method_6(), bool_0: false);
						goto IL_072a;
					case 18u:
						num7 = 92444429;
						continue;
					case 17u:
						gClass = Class171.smethod_231(this, current2.method_8().method_0());
					...
					case 12u:
						...
						continue;
					case 11u:
						num7 = ((smethod_2(current2.method_8().method_0(), Class178.smethod_0(8498), StringComparison.OrdinalIgnoreCase) != -1) ? 283128262 : 1173164818) ^ ((int)num2 * -414334873);
						continue;
					case 10u:
						result = IntPtr.Zero;
					...
					case 9u:
						...
						continue;
					case 6u:
						gClass = @class[string_2];
						num7 = ((int)num2 * -1544337376) ^ -175341128;
						continue;
					case 5u:
						string_2 = Class171.smethod_440(current2.method_8().method_0(), method_8(), null, Enum43.flag_1, 0, IntPtr.Zero);
						num7 = (smethod_3(string_2) ? 385089912 : 717977832);
						continue;
					case 4u:
					...
					case 27u:
						goto end_IL_0646;
					case 30u:
						intPtr = Class171.smethod_248(gClass, current2.method_8().method_4(), bool_0: false);
						goto IL_072a;
					case 0u:
					case 2u:
					case 8u:
