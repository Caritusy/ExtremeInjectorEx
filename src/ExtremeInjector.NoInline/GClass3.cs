...
public sealed class GClass3 : Class84
{
	...
	public sealed class Class81
	{
		...
		{
			return smethod_0(gclass5_0.method_0(), Class178.smethod_0(31201));
		}
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 34u:
						...
						continue;
					case 33u:
						num = ((Class171.smethod_323(@class) != intptr_4) ? 2065742906 : 1975634092) ^ ((int)num2 * -338035221);
						continue;
					case 32u:
						num4 = 0;
					...
					case 25u:
						...
						continue;
					case 21u:
						@class = Class171.smethod_165(class112_)[num3];
						num = -968140648;
						continue;
					case 20u:
					...
					case 10u:
						...
						continue;
					case 9u:
						num = ((Class171.smethod_425(@class) == 0) ? 1656040522 : 2138464495) ^ ((int)num2 * -1382153198);
						continue;
					case 6u:
						...
						continue;
					case 3u:
						Class171.smethod_54(class2, new Class57(Class171.smethod_225(Class171.smethod_42(method_19())[Class178.smethod_0(8549)], Class178.smethod_0(8562), bool_0: false)), CallingConvention.StdCall, new object[1] { intPtr2 });
					...
					case 2u:
						...
						continue;
					case 1u:
						intPtr2 = Class171.smethod_175(this, 2048L, Class124.Enum34.flag_6);
						num = -613920069;
						continue;
					case 0u:
					...
					num = ((num3 >= Class171.smethod_366(class112_)) ? (-420868134) : (-889292319));
					continue;
					IL_02b2:
					num = ((Class171.smethod_323(Class171.smethod_165(class112_)[num4]) == intptr_4) ? (-501275794) : (-715119863));
					continue;
					IL_0159:
					Class171.smethod_226(class2, -1);
					num = ((!Class171.smethod_239(class4, this)) ? (-1827571932) : (-1359804708));
					continue;
					IL_0132:
					num = ((num4 < Class171.smethod_366(class112_)) ? (-468672563) : (-1801828098));
					continue;
					IL_0215:
