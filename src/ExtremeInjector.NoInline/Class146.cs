		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 7u:
				{
					...
					class3.method_1(smethod_0(class5_0));
					class3.method_3(smethod_0(class5_0));
					@class = class3;
					num = -192910608;
					continue;
				}
				...
				case 5u:
					...
					num = ((smethod_2(smethod_1(class5_0)) + num4 * 2 >= smethod_3(smethod_1(class5_0))) ? (-1408135488) : (-93028423)) ^ ((int)num2 * -1308753918);
					continue;
				case 4u:
