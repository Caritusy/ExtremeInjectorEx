...
public sealed class Class20 : WebClient
{
	...
	protected override WebRequest GetWebRequest(Uri address)
	{
		...
		{
			smethod_1(httpWebRequest, Class178.smethod_0(128));
			smethod_2(httpWebRequest, Class178.smethod_0(225));
			smethod_4(smethod_3(httpWebRequest), Class178.smethod_0(310), Class178.smethod_0(331));
			smethod_4(smethod_3(httpWebRequest), Class178.smethod_0(352), Class178.smethod_0(373));
			smethod_5(httpWebRequest, method_0());
			smethod_7(smethod_6(httpWebRequest), bool_0: false);
			smethod_8(httpWebRequest, bool_0: true);
			smethod_9(httpWebRequest, DecompressionMethods.GZip | DecompressionMethods.Deflate);
		}
		return webRequest;
	}
