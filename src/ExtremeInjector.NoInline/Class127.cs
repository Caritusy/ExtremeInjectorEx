...
public static class Class127
{
	...
	{
		public static readonly int int_0 = Class171.smethod_18(smethod_0(typeof(T).TypeHandle));
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 13u:
					...
					continue;
				case 12u:
					bool_1 = Class171.smethod_295(0, 0, 6, -1);
					bool_2 = Class171.smethod_295(1, 0, 6, -1);
					num = ((int)num2 * -734284144) ^ -1913130437;
					continue;
				case 11u:
					bool_11 = Class171.smethod_295(1, 0, 10, -1);
					string_0 = Class171.smethod_268();
					string_1 = smethod_6(string_0, Class178.smethod_0(9674));
				...
				case 10u:
					...
					continue;
				case 9u:
					bool_3 = Class171.smethod_295(1, 2, 5, -1);
					num = (int)((num2 * 461316453) ^ 0x11261B4C);
					continue;
				case 8u:
					string_2 = smethod_6(string_0, Class178.smethod_0(9687));
					string_3 = smethod_6(string_0, Class178.smethod_0(9700));
					num = ((int)num2 * -1065768862) ^ -162682761;
					continue;
				case 7u:
					bool_4 = Class171.smethod_295(1, 3, 5, -1);
					num = (int)((num2 * 1941506399) ^ 0x455E538D);
					continue;
				case 6u:
					bool_6 = Class171.smethod_295(3, 0, 6, -1);
					bool_7 = Class171.smethod_295(0, 0, 10, -1);
					bool_8 = Class171.smethod_295(0, 0, 10, 14393);
					num = ((int)num2 * -1165024855) ^ 0xFDD34F7;
					continue;
				case 5u:
					delegate47_1 = Class171.smethod_276(1);
					delegate47_2 = Class171.smethod_276(2);
					num = (int)(num2 * 2006310185) ^ -1609768697;
					continue;
				case 3u:
					delegate47_0 = Class171.smethod_276(-1);
					num = ((int)num2 * -251384883) ^ 0x4B12ABB6;
					continue;
				case 1u:
					bool_9 = Class171.smethod_295(0, 0, 10, 15063);
					bool_10 = Class171.smethod_295(0, 0, 10, 16299);
					num = ((int)num2 * -380392191) ^ -131118160;
					continue;
				case 0u:
					bool_5 = Class171.smethod_295(2, 0, 6, -1);
					num = (int)((num2 * 801173293) ^ 0x3F38FAEC);
					continue;
				case 4u:
					break;
				default:
					delegate47_3 = Class171.smethod_276(4);
					return;
				}
				break;
			}
	...
	{
		StringBuilder stringBuilder = smethod_7(255);
		int num = 65;
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 1u:
					...
					continue;
				case 0u:
					num2 = ((Class171.QueryDosDevice((char)num + Class178.smethod_0(9709), stringBuilder, stringBuilder.Capacity) != 0) ? (-573336900) : (-1118227608));
					continue;
				case 4u:
					break;
				default:
	...
	{
		return gparam_0[smethod_8(random_0, gparam_0.Length)];
	}

	public static int smethod_3<T>(this T[] gparam_0)
	{
		return smethod_8(random_0, gparam_0.Length);
	}
	...
	public static void smethod_4<T>(this IList<T> ilist_0)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 4u:
				{
					int index = smethod_8(random_0, num + 1);
