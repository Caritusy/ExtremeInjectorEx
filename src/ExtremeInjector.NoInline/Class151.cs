		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 54u:
					...
					continue;
				case 53u:
					num11 = Class171.smethod_135(class154_0, method_15());
					num7 = Class171.smethod_135(class154_0, method_11());
				...
				case 42u:
					...
					continue;
				case 41u:
					@class.method_5(ushort.Parse(smethod_9(text, 1)));
				...
				case 38u:
					...
					continue;
				case 37u:
					num4 = smethod_3(smethod_2(class5_0));
				...
				case 32u:
					...
					continue;
				case 31u:
					text = smethod_5(string_, num13, smethod_7(string_) - num13);
					num = (int)((num2 * 1699360221) ^ 0x65454847);
					continue;
				case 30u:
					Class171.smethod_157(class5_0, num10 + num6 * 4);
					num = 295853607;
					continue;
				case 29u:
					Class171.smethod_157(class5_0, num9);
				...
				case 28u:
					...
					continue;
				case 27u:
					num10 = Class171.smethod_135(class154_0, method_13());
				...
				case 26u:
					...
					continue;
				case 25u:
					Class171.smethod_157(class5_0, num7 + num12 * 4);
					num3 = smethod_0(class5_0);
					num = ((int)num2 * -2733984) ^ -97888507;
					continue;
				case 24u:
					text2 = Class171.smethod_404(class5_0);
				...
				case 23u:
					...
					continue;
				case 22u:
					long_ = Class171.smethod_135(class154_0, num3);
					num = (int)((num2 * 63215318) ^ 0x1DC708BA);
					continue;
				case 21u:
					string_ = Class171.smethod_404(class5_0);
					@class.method_1(smethod_6(smethod_5(string_, 0, smethod_4(string_, '.')), Class178.smethod_0(10075)));
					num = ((int)num2 * -547476598) ^ 0x6995A900;
					continue;
				case 20u:
					method_14(smethod_0(class5_0));
				...
				case 15u:
					num = ((!smethod_8(string_, Class178.smethod_0(10084))) ? (-99001967) : (-22124378)) ^ (int)(num2 * 1145718522);
					continue;
				case 14u:
				...
				case 12u:
					...
					continue;
				case 11u:
					Class171.smethod_157(class5_0, num10);
					num = 829137285;
					continue;
				case 10u:
				{
				...
				case 9u:
					num9 = Class171.smethod_135(class154_0, smethod_0(class5_0));
					num = ((int)num2 * -1903879760) ^ -1586713091;
					continue;
				case 8u:
					Class171.smethod_157(class5_0, num11 + num6 * 2);
					num12 = smethod_1(class5_0);
				...
				case 6u:
					...
					continue;
				case 5u:
					Class171.smethod_157(class5_0, long_);
					num = (int)((num2 * 576154416) ^ 0x757910D5);
					continue;
				case 4u:
					Class171.smethod_157(class5_0, num7 + num5 * 4);
					num8 = smethod_0(class5_0);
