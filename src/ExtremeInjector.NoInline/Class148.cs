...
public class Class148
{
				...
				while (true)
				{
					...
					while (true)
					{
						...
						case 23u:
							...
							continue;
						case 22u:
							string_1 = smethod_3(string_1, 0, num4);
						...
						case 9u:
							...
							continue;
						case 8u:
							num4 = smethod_2(string_1, Class178.smethod_0(10075), StringComparison.OrdinalIgnoreCase);
						...
						case 7u:
							...
							continue;
						case 4u:
							string_0 = smethod_4(string_1, Class178.smethod_0(952), class164_0.method_2());
							int_0 = 1;
							num2 = 1159990593;
							continue;
						case 3u:
						...
						case 2u:
							...
							continue;
						case 0u:
							num2 = ((!smethod_5(ienumerator_0)) ? 2001591733 : 189482537);
							continue;
						default:
							goto end_IL_024a;
						case 6u:
		...
		IEnumerator<string> IEnumerable<string>.GetEnumerator()
		{
			...
			while (true)
			{
				...
				case 5u:
					...
					continue;
				case 4u:
					num = ((int_1 == smethod_1(smethod_0())) ? 59569871 : 1762889299) ^ ((int)num2 * -700373703);
					continue;
				case 3u:
					@class = this;
	...
	public GClass0<string, List<string>> gclass0_0 = new GClass0<string, List<string>>(smethod_0());
	...
	internal Class148(Class5 class5_0, Class154 class154_0)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 26u:
					@class.method_1(smethod_1(class5_0));
					num = ((int)num2 * -212443749) ^ -2083822355;
					continue;
				case 25u:
					long_ = smethod_3(smethod_2(class5_0));
				...
				case 24u:
					...
					continue;
				case 23u:
					@class.method_2(smethod_1(class5_0));
					@class.method_3(smethod_1(class5_0));
				...
				case 17u:
					...
					continue;
				case 16u:
					@class.method_5(smethod_1(class5_0));
					@class.method_7(smethod_1(class5_0));
