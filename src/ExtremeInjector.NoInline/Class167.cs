...
public sealed class Class167
{
	...
	{
		method_1(Class171.smethod_19(class154_0) ? smethod_1(class5_0) : smethod_0(class5_0));
		method_3(Class171.smethod_19(class154_0) ? smethod_1(class5_0) : smethod_0(class5_0));
		method_5(Class171.smethod_19(class154_0) ? smethod_1(class5_0) : smethod_0(class5_0));
		method_7(Class171.smethod_19(class154_0) ? smethod_1(class5_0) : smethod_0(class5_0));
		method_9(smethod_1(class5_0));
		method_11(smethod_1(class5_0));
		long num = Class171.smethod_64(class154_0, method_6());
		if (num != -1L)
		{
			Class171.smethod_157(class5_0, num);
			ulong item;
			while ((item = ((!Class171.smethod_19(class154_0)) ? smethod_0(class5_0) : smethod_1(class5_0))) != 0L)
			{
				list_0.Add(item);
			}
		}
