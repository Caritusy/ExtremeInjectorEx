...
public sealed class InjectorScrambleOptions
{
	...
	{
		public static readonly Type001E _003C_003E9 = new Type001E();

		public static Func<int, int> _003C_003E9__13_0;

		public static Func<object, bool> _003C_003E9__13_1;
	...
	public Enum3 Detect()
	{
		FieldInfo[] array = ((InjectorScrambleOptions)(object)smethod_0(typeof(InjectorScrambleOptions).TypeHandle)).method_0();
		bool flag = true;
		IEnumerator<int> enumerator = ((int[])smethod_1(smethod_0(typeof(Enum3).TypeHandle))).OrderByDescending((int int_0) => int_0).GetEnumerator();
		try
		{
			...
			{
				IL_0303:
				int num = ((!smethod_4(enumerator)) ? (-880559836) : (-272941128));
				while (true)
				{
					uint num2;
					...
					case 13u:
						...
						obj = smethod_2(fieldInfo, bool_0: false).FirstOrDefault((object object_0) => Type001E.smethod_2(Type001E.smethod_0(object_0), Type001E.smethod_1(typeof(Attribute0).TypeHandle)));
						num = -1672854913;
						continue;
					case 11u:
						num = -272941128;
					...
					case 5u:
					{
						bool num5 = (bool)smethod_3(fieldInfo, this);
						flag2 = num5;
	...
	internal static Array smethod_1(Type type_0)
	{
		return Enum.GetValues(type_0);
	}

	internal static object[] smethod_2(MemberInfo memberInfo_0, bool bool_0)
	{
