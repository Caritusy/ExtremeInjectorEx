...
public abstract class Class96 : Class95
{
		...
		: base(int_2)
	{
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 3u:
					int_1 = (bool_2 ? dictionary_0[smethod_9(this)] : dictionary_1[smethod_9(this)]);
					num = 1507801890;
					continue;
				case 1u:
					bool_1 = bool_2;
	...
	protected static void smethod_6<T>(Class168[] class168_0)
	{
		smethod_8<T>(bool_2: true, class168_0);
	}

	protected static void smethod_7<T>(Class168[] class168_0)
	{
		smethod_8<T>(bool_2: false, class168_0);
	}

	internal static void smethod_8<T>(bool bool_2, IList<Class168> ilist_0)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 23u:
					num = (dictionary2.ContainsKey(smethod_10(typeof(T).TypeHandle)) ? (-1886263514) : (-890272922)) ^ ((int)num2 * -796279118);
					continue;
				case 22u:
				...
				case 20u:
					...
					goto IL_004f;
				case 19u:
					dictionary2.Add(smethod_10(typeof(T).TypeHandle), array);
					num = -1106850741;
					continue;
				case 18u:
				...
				case 12u:
					...
					continue;
				case 11u:
					dictionary2[smethod_10(typeof(T).TypeHandle)] = array;
		...
		if (bool_1)
		{
			while (true)
			{
				...
				while (true)
				{
					...
					{
					case 2u:
						num2 = (((object)smethod_10(typeof(T).TypeHandle) == smethod_10(typeof(IntPtr).TypeHandle)) ? (-1809049409) : (-346211655)) ^ (int)(num3 * 316702938);
						continue;
					case 0u:
						break;
					case 1u:
	...
	protected void method_22<T>(int int_2, T gparam_0)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 4u:
					num2 = (((object)smethod_10(typeof(T).TypeHandle) != smethod_10(typeof(IntPtr).TypeHandle)) ? (-350935761) : (-333221278)) ^ (int)(num3 * 1766883677);
					continue;
				case 1u:
