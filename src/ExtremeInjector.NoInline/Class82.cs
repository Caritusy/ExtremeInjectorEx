...
public abstract class Class82
{
	...
	protected virtual void method_04C6()
	{
		...
		while (true)
		{
			...
			case 3u:
				...
				continue;
			case 1u:
				method_3(Class171.OpenProcess(Class124.Enum32.flag_3 | Class124.Enum32.flag_4 | Class124.Enum32.flag_5 | Class124.Enum32.flag_9, bool_0: false, method_0()));
	...
	protected virtual void vmethod_0(IntPtr intptr_1, IntPtr intptr_2, UIntPtr uintptr_0, out UIntPtr uintptr_1)
	{
		...
		while (true)
		{
			...
			case 1u:
				goto IL_00a8;
			case 2u:
				throw smethod_0(Class178.smethod_0(10098));
			case 3u:
				return;
			case 4u:
				throw smethod_0(Class178.smethod_0(10167));
			case 7u:
				return;
			}
			break;
	...
	{
		method_04C6();
		Type type = smethod_1(typeof(T).TypeHandle);
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 12u:
					...
					continue;
				case 11u:
					num = (((object)type == smethod_1(typeof(byte).TypeHandle)) ? 333265105 : 1419965326) ^ (int)(num2 * 2080664007);
					continue;
				case 10u:
					...
					continue;
				case 9u:
					array2[num3] = (T)smethod_3(intPtr.smethod_8(num3 * num4), type);
					num = 1359727763;
					continue;
				case 7u:
					num3++;
	...
	{
		return (T)method_12(smethod_1(typeof(T).TypeHandle), intptr_1);
	}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 4u:
					...
					continue;
				case 3u:
					intPtr = smethod_2(num3);
					num = ((int)num2 * -1702563931) ^ -1967131956;
					continue;
				case 1u:
					num3 = Class171.smethod_232(type_0);
				...
				default:
				{
					object result = smethod_3(intPtr, type_0);
					smethod_4(intPtr);
					return result;
				}
				}
	...
	protected internal bool method_13<T>(IntPtr intptr_1, T gparam_0)
	{
		...
		IntPtr intptr_2 = smethod_2(num);
		smethod_5(gparam_0, intptr_2, bool_1: false);
		bool result = vmethod_2(intptr_2, intptr_1, (UIntPtr)(ulong)num);
		smethod_4(intptr_2);
		return result;
	}
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 0u:
						break;
					case 5u:
						throw smethod_0(Class178.smethod_0(10244));
					default:
						goto end_IL_010a;
					}
					break;
						...
						fixed (byte* ptr = &array2[0])
						{
							...
							while (true)
							{
								...
								case 9u:
									...
									continue;
								case 8u:
									num10 = (((object)smethod_1(typeof(T).TypeHandle) == smethod_1(typeof(byte).TypeHandle)) ? (-1460862255) : (-2080354030));
								...
								case 5u:
									goto end_IL_0076;
								case 3u:
									smethod_5(gparam_0[num6], intptr_2.smethod_8(num6 * num7), bool_1: false);
									num2 = -447535127;
									continue;
								case 2u:
								...
								default:
									result = vmethod_2(intptr_2, intptr_1, (UIntPtr)(ulong)num5);
									smethod_4(intptr_2);
									return result;
								}
								break;
