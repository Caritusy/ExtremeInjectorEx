					...
					while (true)
					{
						...
						while (true)
						{
							...
							case 1u:
								return string.Empty;
							default:
								num4 = ((num6 & 0x1F) << 24) + (byte_0[int_2++] << 16) + (byte_0[int_2++] << 8) + byte_0[int_2++];
								goto case 2u;
							case 2u:
								try
								{
									byte[] array = smethod_5(smethod_4(smethod_3(), byte_0, int_2, num4));
									while (true)
									{
										IL_0246:
										int num7 = 449640665;
										while (true)
										{
											...
											goto IL_0246;
											IL_0202:
											text = smethod_6(smethod_4(smethod_3(), array, 0, array.Length));
	...
	static Class178()
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 1u:
					int_0 = 0;
					num = ((!smethod_8(string_0, global::_003CModule_003E.smethod_3<string>(1753162200u))) ? 1452500361 : 1778634209) ^ ((int)num2 * -1987377030);
					continue;
				case 0u:
					object_0 = smethod_7();
					bool_0 = false;
				...
				default:
				{
					Assembly assembly_ = smethod_10();
					Stream stream = smethod_11(assembly_, global::_003CModule_003E.smethod_5<string>(460238251u));
					try
					{
						int num3 = smethod_13(smethod_12(stream));
						while (true)
						{
							int num4 = 1294845014;
							while (true)
							{
								...
								case 2u:
									...
									continue;
								case 1u:
									smethod_14(stream, byte_, 0, num3);
									byte_0 = Class171.smethod_394(byte_);
