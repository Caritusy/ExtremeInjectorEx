...
public sealed class Form0 : Form
{
	...
	{
		smethod_1(smethod_0(comboBox_0), Class178.smethod_0(394));
		...
		while (true)
		{
			...
			while (true)
			{
				...
				default:
							...
							while (true)
							{
								...
								while (true)
								{
									...
									case 6u:
										...
										continue;
									case 4u:
										smethod_1(smethod_0(comboBox_0), current.method_4());
										num3 = ((!smethod_2(current.method_4(), method_0().string_1)) ? (-446458686) : (-1627027615)) ^ (int)(num2 * 1984859475);
										continue;
									case 3u:
										int_ = smethod_3(smethod_0(comboBox_0)) - 1;
					...
					IL_01b2:
					smethod_4(comboBox_0, int_);
					smethod_1(smethod_0(comboBox_1), Class178.smethod_0(395));
					while (true)
					{
						int num4 = -1090224113;
						while (true)
						{
							...
							{
							case 18u:
								smethod_1(smethod_0(comboBox_2), Class178.smethod_0(479));
								num4 = ((int)num2 * -1559685076) ^ 0x2AAF2DE2;
								continue;
							case 17u:
								smethod_4(comboBox_1, 2);
							...
							case 16u:
								...
								continue;
							case 15u:
								smethod_1(smethod_0(comboBox_1), Class178.smethod_0(417));
							...
							case 13u:
								...
								continue;
							case 12u:
								smethod_1(smethod_0(comboBox_1), Class178.smethod_0(408));
							...
							case 11u:
								...
								continue;
							case 10u:
								smethod_1(smethod_0(comboBox_2), Class178.smethod_0(488));
							...
							case 7u:
								...
								continue;
							case 6u:
								smethod_1(smethod_0(comboBox_2), Class178.smethod_0(470));
								num4 = (int)((num2 * 1268467148) ^ 0x526E179C);
								continue;
							case 5u:
								smethod_4(comboBox_1, 0);
								num4 = -340801925;
								continue;
							case 4u:
								smethod_4(comboBox_1, 0);
							...
							case 2u:
								...
								continue;
							case 1u:
								smethod_1(smethod_0(comboBox_2), Class178.smethod_0(430));
								smethod_1(smethod_0(comboBox_2), Class178.smethod_0(439));
								smethod_1(smethod_0(comboBox_2), Class178.smethod_0(452));
								smethod_1(smethod_0(comboBox_2), Class178.smethod_0(461));
								num4 = -176907944;
								continue;
							case 0u:
								smethod_4(comboBox_1, 1);
	...
	{
		bool flag = smethod_5(comboBox_0) != 0;
		ComboBox control_ = comboBox_1;
		DataGridView control_2 = dataGridView_0;
		ComboBox control_3 = comboBox_2;
		TextBox control_4 = textBox_0;
		bool flag2;
		smethod_6(button_0, flag2 = flag);
		bool flag3;
		smethod_6(control_4, flag3 = flag2);
		bool flag4;
		smethod_6(control_3, flag4 = flag3);
		bool bool_;
		smethod_6(control_2, bool_ = flag4);
		smethod_6(control_, bool_);
		method_0().string_1 = ((smethod_5(comboBox_0) != 0) ? smethod_8(smethod_7(comboBox_0)) : string.Empty);
	}

	internal void method_6(object sender, EventArgs e)
	{
		if (smethod_5(comboBox_1) == 0)
		{
			goto IL_001f;
		}
		goto IL_00e1;
		...
		while (true)
		{
			...
			break;
			IL_0026:
			num = ((smethod_5(comboBox_1) == 2) ? 648360200 : 835743471);
		}
		goto IL_001f;
		IL_00e1:
		num = ((smethod_5(comboBox_1) == 1) ? 1796553505 : 1024556359);
		goto IL_009c;
	}

	internal void method_7(object sender, EventArgs e)
	{
		if (smethod_5(comboBox_2) == -1)
		{
			goto IL_0037;
		}
		goto IL_006d;
		...
		goto IL_0037;
		IL_006d:
		num = (Class171.smethod_342(this, smethod_9(textBox_0), (Enum5)smethod_5(comboBox_2), bool_0: true) ? 1795704142 : 692908412);
		goto IL_003c;
	}
	...
	{
		int num = 0;
		IEnumerator enumerator = smethod_12(smethod_11(dataGridView_0));
		try
		{
			while (true)
			{
				...
				while (true)
				{
					...
					case 2u:
					{
						DataGridViewCell dataGridViewCell = smethod_15(smethod_14((DataGridViewRow)smethod_13(enumerator)), 0);
						int num3 = num + 1;
						num = num3;
	...
	{
		method_0().list_0.RemoveAt(smethod_16(e));
		int num = 0;
		IEnumerator enumerator = smethod_12(smethod_11(dataGridView_0));
		try
		{
