	...
	public Class159(BinaryReader binaryReader_0)
	{
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 4u:
					method_1((Enum40)smethod_0(binaryReader_0));
					method_3(smethod_0(binaryReader_0));
					num = (int)((num2 * 389654741) ^ 0x4503E34F);
					continue;
				case 2u:
					method_7(smethod_1(binaryReader_0));
					method_9(smethod_1(binaryReader_0));
					method_11(smethod_0(binaryReader_0));
				...
				case 3u:
					break;
				default:
					method_13((Enum36)smethod_0(binaryReader_0));
					return;
				}
				break;
			}
