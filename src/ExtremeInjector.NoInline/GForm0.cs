...
public sealed class GForm0 : Form
{
	...
	public sealed class Class22
	{
		...
		{
			return smethod_0(class152_0.method_4(), class21_0.method_0().string_1);
		}
	...
	public sealed class Class23
	{
		...
		{
			return (Class21)smethod_0(dataGridViewRow_0);
		}
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 13u:
						...
						continue;
					case 12u:
						smethod_2(gform0_0, new Action(@class.method_0));
						gForm = gform0_0;
					...
					case 11u:
						...
						continue;
					default:
						smethod_2(gform0_0, new Action(@class.method_1));
						try
						{
						...
						{
							Class171.smethod_158(gform0_0, Class178.smethod_0(3464), exception_);
					...
					case 3u:
						...
						continue;
					case 8u:
						if (!smethod_3(class2.method_0().string_1))
						{
						...
						goto IL_02ae;
					case 7u:
						@class.string_0 = smethod_1(Class171.smethod_243(class2));
					...
					case 5u:
						...
						if (smethod_0(Class171.smethod_243(class2)))
						{
					...
					case 1u:
						Class171.smethod_212(gform0_0, Class12.class12_0.class14_0.int_1, Class178.smethod_0(3411));
					...
					case 0u:
						...
						goto IL_013b;
						IL_02ae:
						Class171.smethod_212(gform0_0, Class12.class12_0.class14_0.int_2, Class178.smethod_0(3533));
						goto IL_0160;
						IL_0160:
						num4 = 133242544;
						goto IL_013b;
						...
						case 0u:
							goto IL_0160;
						default:
							smethod_2(gform0_0, (Action)delegate
							{
	...
	public sealed class Class25
	{
		...
		{
			smethod_1(class26_0.class24_0.gform0_0.label_1, smethod_0(Class178.smethod_0(3602), string_0, Class178.smethod_0(1864)));
		}

		internal void method_1()
		{
			smethod_1(class26_0.class24_0.gform0_0.label_1, smethod_0(Class178.smethod_0(3619), string_0, Class178.smethod_0(3656)));
		}
	...
	public sealed class Class28
	{
		...
		internal void method_0()
		{
			smethod_1(class27_0.gform0_0.label_1, smethod_0(class27_0.string_0, (float)(class27_0.int_0 - int_0) / 1000f));
		}
	...
	public sealed class Class29
	{
		...
		internal void method_0()
		{
			smethod_2(class30_0.gform0_0, smethod_1(new string[9]
			{
				Class178.smethod_0(3661),
				string_0,
				Class178.smethod_0(3738),
				smethod_0(class30_0.string_0),
				Class178.smethod_0(3747),
				string_1,
				Class178.smethod_0(3760),
				class30_0.gform0_0.gclass2_0.method_2(),
				Class178.smethod_0(3777)
	...
	public sealed class Class31
	{
		...
		internal void method_0()
		{
			smethod_0(gform0_0, Class171.smethod_345(string_0, exception_0, bool_0: true), Class178.smethod_0(599), MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
		}
	...
	internal static readonly Dictionary<Enum4, Type> dictionary_0 = new Dictionary<Enum4, Type>
	{
		{
			Enum4.const_0,
			smethod_33(typeof(Class87).TypeHandle)
		},
		{
			Enum4.const_2,
			smethod_33(typeof(Class88).TypeHandle)
		},
		{
			Enum4.const_3,
			smethod_33(typeof(Class86).TypeHandle)
		},
		{
			Enum4.const_1,
			smethod_33(typeof(Class90).TypeHandle)
		}
	};
	...
	public GForm0()
	{
		...
		smethod_0(timer_0);
		Class171.smethod_4(Class10.class10_0, smethod_1(dataGridView_0));
		...
		if (Class127.bool_1)
		{
			smethod_2(dataGridView_0, DataGridViewHeaderBorderStyle.None);
		}
		...
		smethod_3(textBox_0, Class12.class12_0.string_0);
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 3u:
					...
					continue;
				case 2u:
					smethod_3(textBox_0, gClass.method_2());
	...
	internal void method_3(object sender, PaintEventArgs e)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 3u:
					num4 = ((!size.IsEmpty) ? (-747675630) : (-528146501));
					goto IL_0028;
				case 2u:
					break;
				case 0u:
	...
	{
		smethod_7(smethod_6(dataGridView_0));
		while (true)
		{
			int num = -786483381;
			while (true)
	...
	{
		if (smethod_9(smethod_8(dataGridView_0)) <= 0)
		{
			return;
		}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 4u:
					Class12.class12_0.list_0.Remove(((Class21)smethod_12(dataGridViewRow)).method_0());
					num = ((int)num2 * -252673013) ^ -1930896394;
					continue;
				case 3u:
					dataGridViewRow = smethod_10(smethod_8(dataGridView_0), 0);
					smethod_11(smethod_6(dataGridView_0), dataGridViewRow);
	...
	internal void method_6(object sender, EventArgs e)
	{
		if (smethod_9(smethod_8(dataGridView_0)) != 0)
		{
			Class171.smethod_111(this, smethod_13(smethod_10(smethod_8(dataGridView_0), 0)));
		}
	}

	internal void method_7(object sender, EventArgs e)
	{
		OpenFileDialog openFileDialog = smethod_14();
		try
		{
			smethod_15(openFileDialog, Class178.smethod_0(497));
			if (smethod_16(openFileDialog) != DialogResult.OK)
			{
				return;
			}
			while (true)
			{
				...
				while (true)
				{
					...
					{
					case 2u:
						Class171.smethod_349(bool_0: true, null, bool_1: true, this, smethod_17(openFileDialog));
	...
	internal void method_8(object sender, DataGridViewCellMouseEventArgs e)
	{
		...
		while (true)
		{
			...
			case 4u:
				break;
			case 1u:
				Class171.smethod_6((Class21)smethod_12(smethod_21(smethod_6(dataGridView_0), smethod_20(e))));
			...
			case 2u:
				return;
			case 3u:
				Class171.smethod_111(this, smethod_20(e));
				return;
			}
			break;
		}
		goto IL_0017;
		IL_0081:
		num = ((smethod_19(e) != 2) ? 1873441336 : 1655184592);
		goto IL_0050;
	}
	...
	internal void method_14(object sender, EventArgs e)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 2u:
					smethod_3(this, Class171.smethod_275(smethod_25(Class127.random_0, 10, 25)));
	...
	internal void method_15(object sender, MouseEventArgs e)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 9u:
					num = ((smethod_28(this, smethod_27(e)) != button_5) ? 1712314969 : 650290902) ^ ((int)num2 * -597800849);
					continue;
				case 6u:
					num = (Class12.class12_0.class14_0.bool_0 ? (-26103791) : (-650660338));
					continue;
				case 4u:
					smethod_31(Class178.smethod_0(518), Class178.smethod_0(599), MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
					num = ((int)num2 * -1777241989) ^ -676478233;
					continue;
				case 3u:
					smethod_31(Class178.smethod_0(859), Class178.smethod_0(599), MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
					num = -1453238682;
					continue;
				case 0u:
					num = (smethod_30(smethod_29(textBox_0)) ? (-68952149) : (-1871696631));
					continue;
				default:
					return;
				case 7u:
				...
				case 5u:
					return;
				case 8u:
					smethod_31(smethod_32(Class178.smethod_0(628), smethod_29(textBox_0), Class178.smethod_0(705)), Class178.smethod_0(599), MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
					return;
				case 1u:
					return;
				}
