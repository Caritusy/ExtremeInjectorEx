...
public sealed class Class177
{
	...
	internal static Assembly smethod_1(object object_0, ResolveEventArgs resolveEventArgs_0)
	{
		...
		{
			string[] object_1;
			smethod_5(object_1 = string_0);
			try
			{
				assembly_0 = smethod_6(global::_003CModule_003E.smethod_2<string>(3928278315u));
				if ((object)assembly_0 != null)
				{
					while (true)
					{
		...
		string string_ = smethod_9(resolveEventArgs_0);
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 7u:
					...
					continue;
				case 5u:
					num3 = (smethod_10(string_0[num4], string_) ? (-152895505) : (-1477578753));
					continue;
				case 1u:
					num4 = 0;
	...
	internal static bool smethod_2()
	{
		...
		try
		{
			StackFrame[] array = smethod_12(smethod_11());
			int num3 = default(int);
			StackFrame stackFrame_ = default(StackFrame);
			while (true)
			{
				IL_00d8:
				int num = 1563124308;
				while (true)
				{
					...
					{
					case 7u:
						num = ((num3 < array.Length) ? 18248723 : 1253927121);
						continue;
					case 6u:
						num = (((object)smethod_15(smethod_14(smethod_13(stackFrame_))) == smethod_16()) ? (-665157452) : (-180389836)) ^ ((int)num2 * -345158562);
						continue;
					case 4u:
						num3 = 2;
