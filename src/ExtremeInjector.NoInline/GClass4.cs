...
public sealed class GClass4 : IDisposable
{
	...
	public sealed class Class133
	{
		...
		{
			return smethod_0(gclass5_0.method_0(), string_0);
		}
	...
	public sealed class Class136 : IEnumerable<Class138>, IEnumerator<Class138>, IDisposable, IEnumerator, IEnumerable
	{
		...
		IEnumerator<Class138> IEnumerable<Class138>.GetEnumerator()
		{
			...
			while (true)
			{
				...
				{
				case 4u:
					num = ((int_1 == smethod_1(smethod_0())) ? 11253495 : 1793584649) ^ ((int)num2 * -291713645);
					continue;
				case 3u:
	...
	internal readonly Random random_0 = smethod_1();
	...
	{
		MemoryStream memoryStream = smethod_2();
		smethod_3(class154_1.method_28(), 0L);
		class154_1.method_28().smethod_6(memoryStream);
		smethod_3(memoryStream, 0L);
		class154_0 = Class6.smethod_4(memoryStream, bool_0: true, Enum39.const_0);
		binaryWriter_0 = smethod_4(class154_0.method_28());
	...
	internal void method_2()
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 5u:
					smethod_9(binaryWriter_0, byte_);
					num4 = ((int)num3 * -1484368779) ^ 0xEA18D8B;
					continue;
				case 4u:
					smethod_3(class154_0.method_28(), current.method_8() + num);
			...
			goto IL_01ca;
			IL_0072:
			Stream stream = Class171.smethod_264(class154_0, current.method_8(), (int)(smethod_5(class154_0.method_28()) - current.method_8()));
			try
			{
				BinaryReader binaryReader = smethod_6(stream);
				try
				{
					byte_ = smethod_7(binaryReader, (int)smethod_5(stream));
				}
				finally
				{
			...
			while (true)
			{
				...
				while (true)
				{
					...
					try
					{
						...
						try
						{
							smethod_3(class154_0.method_28(), current.method_8());
							while (true)
							{
								IL_0354:
								int num3 = -1639126865;
								while (true)
								{
									...
									case 19u:
										...
										continue;
									case 18u:
										array = smethod_7(binaryReader, (int)current.method_6());
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 4u:
					...
					continue;
				case 3u:
					num18 = smethod_11(random_0, num27, 10);
					num = 124659322;
					continue;
				case 2u:
					num26 = num18 * 40;
				...
				default:
					...
					while (true)
					{
						...
						default:
						{
							Stream stream = Class171.smethod_264(class154_0, num4, (int)(smethod_5(class154_0.method_28()) - num4));
							byte[] byte_;
							try
							{
								BinaryReader binaryReader = smethod_6(stream);
							...
							smethod_3(class154_0.method_28(), num10);
							smethod_9(binaryWriter_0, byte_);
							uint num11 = 0u;
							uint num12 = 0u;
							using (List<GClass5>.Enumerator enumerator = class154_0.method_8().GetEnumerator())
							...
							byte_ = new byte[0];
							if (num11 < smethod_5(class154_0.method_28()))
							{
								Stream stream2 = Class171.smethod_264(class154_0, num11, (int)(smethod_5(class154_0.method_28()) - num11));
								try
								{
									BinaryReader binaryReader2 = smethod_6(stream2);
									try
									{
										byte_ = smethod_7(binaryReader2, (int)smethod_5(stream2));
									}
									finally
									{
							...
							while (true)
							{
								...
								while (true)
								{
									...
									case 39u:
										...
										continue;
									case 38u:
										smethod_3(class154_0.method_28(), num11);
									...
									case 34u:
										...
										continue;
									case 33u:
										num16 = ((num19 >= smethod_12(random_0, array.Length)) ? 1779669402 : 542376334);
										continue;
									case 32u:
										num17 = smethod_12(random_0, num18);
										num16 = 1675564108;
										continue;
									case 31u:
									...
									case 21u:
										...
										continue;
									case 20u:
										@enum = array[smethod_12(random_0, array.Length)];
										num16 = 1985498757;
										continue;
									case 19u:
										num24++;
										...
										continue;
									case 18u:
										num22 = smethod_12(random_0, num18);
										num16 = 1959509111;
										continue;
									case 17u:
									...
									case 12u:
										...
										continue;
									case 11u:
										num23 = smethod_12(random_0, num18);
									...
									case 6u:
										...
										continue;
									case 5u:
										num20 = smethod_12(random_0, num18);
										num16 = 1807791787;
										continue;
									case 4u:
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 23u:
					...
					continue;
				case 22u:
					smethod_14(binaryWriter_0, num8);
					smethod_14(binaryWriter_0, num4);
					smethod_14(binaryWriter_0, num5);
					smethod_14(binaryWriter_0, uint_2);
					num = (int)((num2 * 715802246) ^ 0x7EEE32C6);
					continue;
				case 21u:
					list.Add(num7);
					smethod_3(class154_0.method_28(), gclass5_0.method_8() + (num7 - num6 - gclass5_0.method_4()));
					num = 740061908;
					continue;
				case 20u:
					smethod_3(class154_0.method_28(), gclass5_0.method_8());
					smethod_14(binaryWriter_0, num9);
				...
				case 19u:
					...
					continue;
				case 18u:
					smethod_14(binaryWriter_0, uint_);
					num = (int)((num2 * 1117759861) ^ 0x2766A568);
					continue;
				case 17u:
					uint_ = class154_0.method_20().method_10();
					num = ((int)num2 * -1058305703) ^ 0x709EE8F1;
					continue;
				case 16u:
					smethod_3(class154_0.method_28(), gclass5_0.method_8() + (num5 - num6 - gclass5_0.method_4()));
				...
				case 13u:
				{
					BinaryWriter binaryWriter_ = binaryWriter_0;
					byte[] array = new byte[6];
					smethod_13(array, (RuntimeFieldHandle)/*OpCode not supported: LdMemberToken*/);
					smethod_9(binaryWriter_, array);
				...
				case 11u:
					...
					continue;
				case 10u:
					uint_2 = class154_0.method_20().method_8();
						...
						while (true)
						{
							...
							while (true)
							{
								...
								case 2u:
								{
									...
									smethod_14(binaryWriter_0, current);
									num3 = 887995814;
									continue;
								}
								default:
	...
	internal void method_7(List<Class132> list_0)
	{
		...
		BinaryWriter binaryWriter_ = smethod_4(class154_0.method_28());
		smethod_3(class154_0.method_28(), Class171.smethod_135(class154_0, class154_0.method_6().method_3().imethod_49()[1].method_0()));
		...
		while (true)
		{
			...
			if (enumerator.MoveNext())
			{
				while (true)
				{
					...
					while (true)
					{
						...
						case 6u:
							...
							continue;
						case 5u:
							smethod_14(binaryWriter_, Class171.smethod_33(list_0, current.method_6()));
							long_ = smethod_16(class154_0.method_28());
							smethod_3(class154_0.method_28(), Class171.smethod_135(class154_0, current.method_0()));
							num = ((int)num2 * -857508609) ^ -1702002374;
							continue;
						case 2u:
							smethod_14(binaryWriter_, Class171.smethod_33(list_0, current.method_0()));
							num = ((int)num2 * -2035643783) ^ 0x6CAA37E6;
							continue;
						case 1u:
						{
							Stream stream_ = class154_0.method_28();
							smethod_3(stream_, smethod_16(stream_) + 8L);
							num = (int)(num2 * 1246749018) ^ -1762608560;
							continue;
						}
						case 0u:
							smethod_14(binaryWriter_, Class171.smethod_33(list_0, current.method_4()));
				...
				using (List<Class164>.Enumerator enumerator2 = current.method_8().GetEnumerator())
				{
					while (true)
					{
						...
						while (true)
						{
							...
							case 5u:
							{
								Stream stream_2 = class154_0.method_28();
								smethod_3(stream_2, smethod_16(stream_2) + (Class171.smethod_19(class154_0) ? 4 : 8));
								num3 = -2129259869;
								continue;
							}
							case 3u:
							...
							case 2u:
							{
								ulong num4;
								current2.method_1(num4 = Class171.smethod_33(list_0, (uint)current2.method_0()));
								smethod_14(binaryWriter_, (uint)num4);
				...
				{
					smethod_3(class154_0.method_28(), Class171.smethod_135(class154_0, current.method_6()));
					...
					while (true)
					{
						...
						while (true)
						{
							...
							case 1u:
							{
								Stream stream_3 = class154_0.method_28();
								smethod_3(stream_3, smethod_16(stream_3) + (Class171.smethod_19(class154_0) ? 4 : 8));
								num5 = -382573913;
								continue;
							}
							case 0u:
			...
			while (true)
			{
				...
				case 1u:
					...
					smethod_3(class154_0.method_28(), long_);
	...
	internal void method_8(List<Class132> list_0)
	{
		...
		default:
		{
			smethod_3(class154_0.method_28(), Class171.smethod_135(class154_0, class154_0.method_6().method_3().imethod_49()[3].method_0()));
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 4u:
					{
						BinaryWriter binaryWriter_3 = binaryWriter;
						uint uint_;
						current.method_3(uint_ = Class171.smethod_33(list_0, current.method_2()));
						smethod_14(binaryWriter_3, uint_);
						num2 = (int)(num3 * 29284499) ^ -1487425163;
						continue;
					}
					case 2u:
					{
						BinaryWriter binaryWriter_2 = binaryWriter;
						uint uint_;
						current.method_1(uint_ = Class171.smethod_33(list_0, current.method_0()));
						smethod_14(binaryWriter_2, uint_);
					...
					case 0u:
					{
						...
						uint uint_;
						current.method_5(uint_ = Class171.smethod_33(list_0, current.method_4()));
						smethod_14(binaryWriter_, uint_);
		...
		goto IL_000d;
		IL_0034:
		binaryWriter = smethod_4(class154_0.method_28());
		num = -1822981006;
		goto IL_0012;
	}
	...
	internal void method_9(List<Class132> list_0)
	{
			...
			default:
			{
				...
				while (true)
				{
					if (enumerator.MoveNext())
					{
						...
						smethod_3(class154_0.method_28(), num3);
						smethod_14(binaryWriter_, Class171.smethod_33(list_0, current.method_0()));
							...
							while (true)
							{
								...
								while (true)
								{
									...
									case 10u:
										...
										continue;
									case 9u:
										smethod_14(binaryWriter_, (uint)(int)num5 + Class171.smethod_33(list_0, num6 - (uint)(int)num5));
									...
									case 5u:
									{
										num7 = smethod_19(binaryReader_);
										Stream stream_2 = class154_0.method_28();
										smethod_3(stream_2, smethod_16(stream_2) - 8L);
										num4 = (int)((num2 * 1012304616) ^ 0x517823BB);
										continue;
									}
									case 4u:
									{
										num6 = smethod_18(binaryReader_);
										Stream stream_ = class154_0.method_28();
										smethod_3(stream_, smethod_16(stream_) - 4L);
									...
									case 3u:
										...
										continue;
									case 2u:
										smethod_3(class154_0.method_28(), Class171.smethod_135(class154_0, current.method_0() + current2.method_0()));
										num4 = ((int)num2 * -37649823) ^ 0x49CF5D8C;
										continue;
									case 1u:
										smethod_17(binaryWriter_, num5 + Class171.smethod_33(list_0, (uint)(num7 - num5)));
		...
		goto IL_0070;
		IL_009f:
		binaryReader_ = smethod_6(class154_0.method_28());
		binaryWriter_ = smethod_4(class154_0.method_28());
		num = -1185638126;
		goto IL_0075;
	}
