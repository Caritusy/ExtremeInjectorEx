...
public static class Class46
{
	...
	{
		return (uint)smethod_12(random_0);
	}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 2u:
					break;
				case 0u:
					return (uint)smethod_13(random_0, num3, (int)uint_0);
				default:
					return (uint)smethod_13(random_0, (int)uint_0, num3);
				}
				break;
				IL_0020:
	...
	{
		return (ushort)smethod_13(random_0, 0, 65536);
	}

	public static byte smethod_3(this Random random_0)
	{
		byte[] array = new byte[1];
		smethod_14(random_0, array);
		return array[0];
	}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 2u:
					return string.Empty;
				default:
					return smethod_16(smethod_15(fileStream));
				}
				break;
				IL_0022:
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 6u:
					...
					continue;
				case 5u:
					num4 = smethod_17(stream_0, array, num, int_0);
					num2 = 1471333986;
					continue;
				case 4u:
					num += num4;
				...
				case 2u:
					...
					continue;
				case 1u:
					smethod_18(stream_1, array, 0, array.Length);
					num2 = 773438149;
					continue;
				default:
					return;
	...
	public static void smethod_6(this Stream stream_0, Stream stream_1)
	{
		...
		while (true)
		{
			...
			{
			case 14u:
				num = (smethod_21(stream_0) ? (-757720809) : (-260069994)) ^ (int)(num2 * 913383088);
				continue;
			case 11u:
				break;
			case 10u:
			...
			case 5u:
				...
				continue;
			case 4u:
				smethod_18(stream_1, array, 0, int_);
				num = -27641909;
				continue;
			case 2u:
				goto IL_00e0;
			case 1u:
				...
				continue;
			case 0u:
				num = (smethod_21(stream_1) ? (-1708827674) : (-20465854)) ^ (int)(num2 * 1581688569);
				continue;
			default:
				return;
			case 3u:
				goto IL_019c;
			case 6u:
				throw smethod_22(Class178.smethod_0(4456));
			case 7u:
				throw smethod_23();
			case 12u:
				throw smethod_19(Class178.smethod_0(4456));
			case 13u:
				throw smethod_22(null);
			case 16u:
				throw smethod_23();
			case 15u:
				return;
			}
			num = (smethod_21(stream_1) ? (-494346291) : (-1690601485));
			continue;
			IL_00e0:
			num = ((!smethod_20(stream_1)) ? (-1115020739) : (-1253178943));
			continue;
			IL_0072:
			num = ((!smethod_20(stream_0)) ? (-1414110935) : (-1948648809));
			continue;
			IL_0096:
			num = (((int_ = smethod_17(stream_0, array, 0, array.Length)) != 0) ? (-2142299892) : (-14215918));
			continue;
			end_IL_0137:
			break;
		}
		goto IL_0068;
		IL_019c:
		num = ((!smethod_20(stream_0)) ? (-56000411) : (-187917369));
		goto IL_0137;
	}
