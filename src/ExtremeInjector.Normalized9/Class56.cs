	...
	public override bool Equals(object obj)
	{
		...
		while (true)
		{
			...
			case 3u:
				goto IL_0014;
			case 2u:
				num = ((Class171.smethod_213(@class).enum8_0 == @struct.enum8_0) ? (-1234531591) : (-860608492)) ^ (int)(num2 * 1807140430);
				continue;
			case 0u:
				goto IL_00a3;
			default:
			...
			break;
			IL_0014:
			num = ((Class171.smethod_213(@class).byte_0 == @struct.byte_0) ? (-1273019657) : (-1860768839));
		}
		goto IL_000d;
		IL_00a3:
