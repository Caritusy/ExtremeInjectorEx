		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 4u:
					...
					continue;
				case 3u:
					Class171.smethod_428(this, current.method_8(), num);
			...
			goto IL_01ca;
			IL_0072:
			Stream stream = Class171.smethod_258(class154_0, current.method_8(), (int)(class154_0.method_28().Length - current.method_8()));
			try
			{
		...
		while (enumerator.MoveNext())
		{
			while (true)
			{
				...
				while (true)
				{
					...
					continue;
					IL_00c1:
					Stream stream = Class171.smethod_258(class154_0, current.method_8(), (int)current.method_6());
					try
					{
						BinaryReader binaryReader = new BinaryReader(stream);
						try
											...
											while (true)
											{
												...
												while (true)
												{
													...
													case 1u:
													{
														...
														Class171.smethod_428(this, current2.Key, current2.Value);
														num4 = -242992493;
														continue;
													}
													default:
			...
			while (true)
			{
				...
				default:
					...
					while (true)
					{
						...
						default:
						{
							Stream stream = Class171.smethod_258(class154_0, num4, (int)(class154_0.method_28().Length - num4));
							byte[] buffer;
							try
							{
								BinaryReader binaryReader = new BinaryReader(stream);
							...
							Class171.smethod_371(this, num6, num10 - num6);
							...
							{
								Stream stream2 = Class171.smethod_258(class154_0, num11, (int)(class154_0.method_28().Length - num11));
								try
								{
							...
							while (true)
							{
								...
								while (true)
								{
									...
									{
									case 60u:
										num12 = Class171.smethod_199(uint_, num12);
									...
									case 54u:
										...
										num21 = Class171.smethod_199(uint_, gClass3.method_2());
									...
									case 45u:
										...
										continue;
									case 44u:
										Class171.smethod_428(this, gClass3.method_8(), gClass3.method_6());
									...
									case 32u:
										...
										continue;
									case 31u:
										gClass3.method_7(Class171.smethod_199(uint_2, num21));
										array = new Enum41[4]
										{
											Enum41.flag_34,
											Enum41.flag_32,
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 2u:
					...
					continue;
				case 1u:
					Class171.smethod_428(this, gclass5_0.method_8(), gclass5_0.method_6());
							...
							while (true)
							{
								...
								while (true)
								{
									...
									case 1u:
									{
										...
										num6 = Class171.smethod_199(uint_2, uint_);
