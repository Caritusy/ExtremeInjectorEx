...
public class GClass8
{
	...
	{
		internal Struct86 struct86_0;

		internal Struct86 struct86_1;

		internal Struct87 struct87_0 = new Struct87(8);

		internal Struct87[] struct87_1 = new Struct87[16];

		internal Struct87[] struct87_2 = new Struct87[16];
	...
	internal Struct86[] struct86_0 = new Struct86[192];

	internal Struct86[] struct86_1 = new Struct86[192];

	internal Struct86[] struct86_2 = new Struct86[12];

	internal Struct86[] struct86_3 = new Struct86[12];

	internal Struct86[] struct86_4 = new Struct86[12];

	internal Struct86[] struct86_5 = new Struct86[12];

	internal Class188 class188_0 = new Class188();

	internal Class189 class189_0 = new Class189();

	internal GClass9 gclass9_0 = new GClass9();

	internal Struct87 struct87_0 = new Struct87(4);

	internal Struct86[] struct86_6 = new Struct86[114];

	internal Struct87[] struct87_1 = new Struct87[4];

	internal uint uint_2;

	internal Class190 class190_0 = new Class190();
