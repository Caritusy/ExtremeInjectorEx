			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 29u:
						...
						continue;
					case 28u:
						result = Class171.smethod_220(gClass, current2.method_8().method_6(), bool_0: false);
						num7 = 228034350;
						continue;
					case 26u:
					...
					case 19u:
						...
						intPtr = Class171.smethod_220(gClass, current2.method_8().method_6(), bool_0: false);
						goto IL_072a;
					case 18u:
						num7 = 92444429;
						continue;
					...
					case 6u:
						...
						continue;
					case 5u:
						value = Class171.smethod_431(current2.method_8().method_0(), method_8(), null, Enum43.flag_1, 0, IntPtr.Zero);
					...
					case 27u:
						goto end_IL_0646;
					case 30u:
						intPtr = Class171.smethod_242(gClass, current2.method_8().method_4(), bool_0: false);
						goto IL_072a;
					case 0u:
					case 2u:
					case 8u:
