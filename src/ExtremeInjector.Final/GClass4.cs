...
public sealed class GClass4 : IDisposable
{
	...
	public sealed class Class136 : IEnumerable<Class138>, IEnumerator<Class138>, IEnumerable, IEnumerator, IDisposable
	{
		...
		private Class138 System_002ECollections_002EGeneric_002EIEnumerator_003CClass138_003E_002ECurrent => class138_0;

		private object System_002ECollections_002EIEnumerator_002ECurrent => class138_0;
		...
		private IEnumerator<Class138> GetEnumerator()
		{
			if (int_0 == -2)
			{
				goto IL_0078;
		...
		private IEnumerator GetEnumerator_03EA()
		{
		...
		{
			//ILSpy generated this explicit interface implementation from .override directive in GetEnumerator_03EA
			return this.GetEnumerator_03EA();
		}
	}
