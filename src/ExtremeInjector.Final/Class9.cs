...
public static class Class9
{
	...
	static MethodInfo method_0(Type type, string string_0)
	{
		return type.GetMethod(string_0);
	}

	static MethodInfo method_1(Type type, string string_0, Type[] type_1)
	{
		return type.GetMethod(string_0, type_1);
	}

	static ConstructorInfo method_2(Type type, Type[] type_1)
	{
