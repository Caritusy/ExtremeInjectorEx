		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 24u:
					...
					num = ((!(Class171.smethod_434(intPtr, @class, (Class84)this) == IntPtr.Zero)) ? 313284391 : 786565798) ^ ((int)num2 * -1318042794);
					continue;
				case 23u:
				...
				default:
					...
					Class171.smethod_420(@class, class63_, Class171.smethod_409(class63_, (long)num8, class47_));
