		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 54u:
					...
					continue;
				case 53u:
					num11 = Class171.smethod_134(class154_0, method_15());
					num7 = Class171.smethod_134(class154_0, method_11());
				...
				case 31u:
					...
					continue;
				case 30u:
					Class171.smethod_156(class5_0, num10 + num6 * 4);
					num = 295853607;
					continue;
				case 29u:
					Class171.smethod_156(class5_0, num9);
				...
				case 28u:
					...
					continue;
				case 27u:
					num10 = Class171.smethod_134(class154_0, method_13());
				...
				case 26u:
					...
					continue;
				case 25u:
					Class171.smethod_156(class5_0, num7 + num12 * 4);
				...
				case 15u:
					num = ((!text3.Contains(Class178.smethod_0(10084))) ? (-99001967) : (-22124378)) ^ (int)(num2 * 1145718522);
					continue;
				case 14u:
				...
				case 12u:
					...
					continue;
				case 11u:
					Class171.smethod_156(class5_0, num10);
					num = 829137285;
					continue;
				case 10u:
				{
				...
				case 9u:
					num9 = Class171.smethod_134(class154_0, class5_0.ReadUInt32());
					num = ((int)num2 * -1903879760) ^ -1586713091;
					continue;
				case 8u:
					Class171.smethod_156(class5_0, num11 + num6 * 2);
				...
				case 5u:
					...
					continue;
				case 4u:
					Class171.smethod_156(class5_0, num7 + num5 * 4);
					num8 = class5_0.ReadUInt32();
					num = (int)(num2 * 2035430827) ^ -211863213;
					continue;
				case 2u:
					Class171.smethod_156(class5_0, num4);
