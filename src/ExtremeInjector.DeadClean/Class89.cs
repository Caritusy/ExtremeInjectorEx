				...
				case 6u:
					...
					while (true)
					{
						...
						case 3u:
							...
							num7 = (Class171.smethod_233(class2, (Class84)this) ? (-1088384881) : (-828128323)) ^ (int)(num2 * 1699594358);
							continue;
						case 2u:
							break;
						case 1u:
	...
	internal bool method_44(Class172 class172_0)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 5u:
					num = (method_16(intptr_, Class171.smethod_8((long)@class.method_6().method_3().imethod_31(), @class, 0L)) ? 1705303002 : 1492710215) ^ ((int)num2 * -1485933316);
					continue;
				case 1u:
