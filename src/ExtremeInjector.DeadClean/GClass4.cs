			...
			while (true)
			{
				...
				default:
					...
					while (true)
					{
						...
						default:
						{
							Stream stream = Class171.smethod_258(class154_0, (long)num4, (int)(class154_0.method_28().Length - num4));
							byte[] buffer;
							try
							{
								BinaryReader binaryReader = new BinaryReader(stream);
							...
							Class171.smethod_371(this, (long)num6, (long)(num10 - num6));
							...
							{
								Stream stream2 = Class171.smethod_258(class154_0, (long)num11, (int)(class154_0.method_28().Length - num11));
								try
								{
				...
				using (List<Class164>.Enumerator enumerator2 = current.method_8().GetEnumerator())
				{
					while (true)
					{
						...
						while (true)
						{
							...
							{
								ulong num4;
								current2.method_1(num4 = Class171.smethod_33((IEnumerable<Class132>)list_0, (uint)current2.method_0()));
				...
				if (current.method_6() != current.method_0())
				{
					...
					while (true)
					{
						...
						while (true)
						{
							...
							{
								ulong num4;
								current3.method_1(num4 = Class171.smethod_33((IEnumerable<Class132>)list_0, (uint)current3.method_0()));
								binaryWriter.Write((uint)num4);
							...
							while (true)
							{
								...
								while (true)
								{
									...
									case 10u:
										...
										continue;
									case 9u:
										binaryWriter.Write((uint)(int)num5 + Class171.smethod_33((IEnumerable<Class132>)list_0, num6 - (uint)(int)num5));
									...
									case 2u:
										...
										continue;
									case 1u:
										binaryWriter.Write(num5 + Class171.smethod_33((IEnumerable<Class132>)list_0, (uint)(num7 - num5)));
