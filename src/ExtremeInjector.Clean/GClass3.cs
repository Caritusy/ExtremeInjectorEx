			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 6u:
						...
						continue;
					case 3u:
						Class171.smethod_54(class2, new Class57(Class171.smethod_225(Class171.smethod_42(method_19())["ntdll.dll"], "RtlEncodeSystemPointer", bool_0: false)), CallingConvention.StdCall, new object[1] { intPtr2 });
