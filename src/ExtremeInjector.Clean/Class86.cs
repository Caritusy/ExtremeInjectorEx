	...
	public override IntPtr method_0BA6(string string_0)
	{
		...
		while (true)
		{
			...
			case 7u:
				...
				continue;
			case 5u:
				intPtr3 = Class171.smethod_225(gClass, "LdrLoadDll", bool_0: false);
				num = 452747149;
				continue;
			case 4u:
				goto IL_01d0;
			...
			case 9u:
				throw new Exception("LdrLoadDll failed to load the specified DLL. (NT Status: 0x" + num3.ToString("X8") + ")", Class171.smethod_213(num3, this));
			case 10u:
