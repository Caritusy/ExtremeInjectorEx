...
public sealed class Stream0 : Stream, Interface0
{
	...
	public Stream0(IntPtr intptr_2, IntPtr intptr_3, Enum15 enum15_1, long long_2)
	{
		...
		enum15_0 = enum15_1;
		long_0 = ((long_2 == -1L) ? Class171.smethod_407(this, intptr_3) : long_2);
		intptr_0 = intptr_2;
		intptr_1 = intptr_3;
		bool_0 = true;
	}
	...
	public unsafe override int Read(byte[] buffer, int offset, int count)
	{
		...
		{
			succeeded = Class171.ReadProcessMemory_1(intptr_0, intptr_1.smethod_9(long_1), pointer + offset,
	...
	public unsafe override void Write(byte[] buffer, int offset, int count)
	{
		...
		Class124.Enum34 oldProtection = default(Class124.Enum34);
		bool protectionChanged = false;
		if (method_0())
		{
			protectionChanged = Class171.VirtualProtectEx(intptr_0, intptr_1.smethod_9(long_1),
				(UIntPtr)(ulong)count, Class124.Enum34.flag_2, out oldProtection);
		...
		fixed (byte* pointer = buffer)
		{
			succeeded = Class171.WriteProcessMemory_1(intptr_0, intptr_1.smethod_9(long_1), pointer + offset,
				(UIntPtr)(ulong)count, &bytesWritten);
		}
		if (protectionChanged)
		{
			Class171.VirtualProtectEx(intptr_0, intptr_1.smethod_9(long_1), (UIntPtr)(ulong)count,
