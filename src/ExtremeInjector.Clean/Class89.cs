...
public sealed class Class89(GClass2 gclass2_1) : Class85(gclass2_1)
{
	...
	public override IntPtr method_0BA6(string string_0)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				default:
				{
					Enum44 enum44_ = Class171.smethod_206(this);
	...
	{
		GClass1 gClass = Class171.smethod_42(method_19())["ntdll.dll"];
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 13u:
					...
					continue;
				case 12u:
					intPtr = Class171.smethod_225(gClass, "RtlActivateActivationContext", bool_0: false);
					num = 1163373165;
					continue;
				case 11u:
					intPtr2 = Class171.smethod_225(gClass, "RtlDeactivateActivationContext", bool_0: false);
					class2 = new Class53();
				...
				case 7u:
					...
					if (!Class171.smethod_427(method_19()))
					{
				...
				case 6u:
					{
						return Class171.smethod_128(this, new FileNotFoundException("Unable to find ntdll.dll in the specified process."));
					}
					IL_03c6:
					...
					while (true)
					{
						...
						{
						case 3u:
							Class171.smethod_336(class47_);
							num7 = (Class171.smethod_239(class2, this) ? (-1088384881) : (-828128323)) ^ (int)(num2 * 1699594358);
							continue;
						case 2u:
							break;
						case 1u:
							Class171.smethod_429(class2, class3, Class171.smethod_221(class47_, class58_, 0L));
						...
						case 4u:
							goto IL_05cc;
						case 5u:
							return Class171.smethod_128(this, new AccessViolationException("Unable to call the entrypoint(s) of the DLL."));
						default:
							return true;
						}
						break;
					...
					goto IL_059e;
					IL_05cc:
					Class171.smethod_226(class47_, -1);
					Class171.smethod_227(class47_);
	...
	internal IntPtr method_38(string string_0, Enum44 enum44_0)
	{
		...
		while (true)
		{
			...
			case 29u:
				...
				continue;
			case 26u:
				Class171.smethod_283(intPtr, Class171.smethod_42(method_19()));
				Class171.smethod_368(class2);
				vmethod_6(class2.method_2());
			...
			case 23u:
				...
				continue;
			case 22u:
				num4 = ((!Class171.smethod_424(this, class2)) ? 1923964314 : 479293003) ^ ((int)num2 * -60552625);
				continue;
			case 21u:
				Class171.smethod_368(class2);
			...
			case 5u:
				...
				continue;
			case 4u:
				Class171.smethod_242(this, class2);
			...
			continue;
			IL_03ee:
			Class171.smethod_266(Class171.smethod_42(method_19()), class3, intPtr, Class171.smethod_427(method_19()));
	...
	internal bool method_40()
	{
		...
		while (true)
		{
			...
			{
			case 30u:
				num = ((!Class171.smethod_340("\u008Bÿ", 0, array)) ? (-95892414) : (-469689408)) ^ (int)(num2 * 1775755729);
				continue;
			case 29u:
			...
			case 26u:
				break;
			case 25u:
				num = (((num3 = Class171.smethod_419(array, "Â\0\0", "x?x", 0)) != -1) ? (-214482323) : (-2119293287)) ^ ((int)num2 * -149492349);
				continue;
			case 23u:
			{
			...
			case 22u:
				intPtr = Class171.smethod_225(gClass, "RtlUnwind", bool_0: false);
				num = -1345636675;
				continue;
			case 21u:
				num3 = Class171.smethod_419(array, "Pè\0\0\0\0\u0084À\u000F\u0084", "xx????xxxx", 0);
			...
			case 10u:
				goto IL_039c;
			case 0u:
				return Class171.smethod_128(this, new AccessViolationException("Unable to unprotect the code required to disable SafeSEH."));
			case 1u:
				return Class171.smethod_128(this, new FileNotFoundException("Unable to find ntdll.dll in the specified process."));
			case 4u:
				return Class171.smethod_128(this, new InvalidOperationException("Unable to find return size when patching SafeSEH."));
			case 6u:
				return Class171.smethod_128(this, new AccessViolationException("Unable to write or protect the code required to disable SafeSEH."));
			case 7u:
				return Class171.smethod_128(this, new InvalidOperationException("Incorrect method detected when patching SafeSEH."));
			default:
				return true;
			case 16u:
				return Class171.smethod_128(this, new InvalidOperationException("Incorrect method detected when patching SafeSEH."));
			...
			case 18u:
				return true;
			case 24u:
				return Class171.smethod_128(this, new InvalidOperationException("Unable to find the pattern required to patch SafeSEH."));
			case 28u:
				return Class171.smethod_128(this, new MissingMethodException("Unable to find RtlUnwind inside ntdll.dll."));
			}
			break;
			IL_0237:
			array = method_10<byte>(intptr_, 200);
			num = (((num3 = Class171.smethod_378(array, "°\u0001", 0)) == -1) ? (-1443517686) : (-1486477485));
			continue;
			IL_0170:
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 6u:
						...
						continue;
					case 5u:
						result = Class171.smethod_128(this, new AccessViolationException("Unable to apply proper protection to the image sections."));
	...
	internal bool method_42(Class172 class172_0, Class148 class148_0)
	{
		...
		while (true)
		{
			...
			{
			case 10u:
				gClass = Class171.smethod_196(Class171.smethod_42(method_19()), intPtr);
				num = -492946928;
				continue;
			case 8u:
				break;
				...
				using (List<Class164>.Enumerator enumerator = @class.method_8().GetEnumerator())
				{
					while (true)
					{
						...
						while (true)
						{
							...
							{
							case 12u:
								intPtr2 = Class171.smethod_225(gClass, current.method_4(), bool_0: false);
								goto IL_012a;
							case 11u:
								if (!Class171.smethod_427(method_19()))
								{
							...
							case 8u:
								...
								intPtr2 = Class171.smethod_248(gClass, current.method_2(), bool_0: false);
								goto IL_012a;
							case 7u:
								num4 = -873746203;
								continue;
							case 5u:
								result = Class171.smethod_128(this, new MissingMethodException("Unable to resolve the function '" + (current.method_7() ? current.method_2().ToString() : current.method_4()) + "' inside the module: " + text));
								num4 = -1311108833;
								continue;
							case 3u:
								current = enumerator.Current;
								...
								continue;
							case 2u:
								result = Class171.smethod_128(this, new AccessViolationException("Unable to write the address into the import address table."));
			...
			case 11u:
				goto IL_036f;
			case 5u:
				return Class171.smethod_128(this, new Exception("Unable to find the specified module: " + text));
			case 9u:
				return false;
			case 12u:
				{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 6u:
					break;
				case 0u:
					return Class171.smethod_128(this, new InvalidOperationException("Unable to relocate image because base relocation directory is not present in: " + class172_0.method_6()));
				case 1u:
					return true;
				default:
				{
							...
							while (true)
							{
								...
								while (true)
								{
									...
									case 15u:
										...
										continue;
									case 14u:
										result = Class171.smethod_128(this, new AccessViolationException("Unable to write memory for relocated block."));
									...
									case 12u:
										...
										continue;
									case 10u:
										result = Class171.smethod_128(this, new InvalidOperationException("Unrecognised base relocation type encountered: " + current2.method_2()));
										num4 = -411687850;
										continue;
									case 9u:
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 4u:
					break;
				case 0u:
					return Class171.smethod_128(this, new AccessViolationException("Unable to set protection for the PE header."));
				case 2u:
					return Class171.smethod_128(this, new AccessViolationException("Unable to write the PE header to the process."));
				default:
				{
						...
						while (true)
						{
							...
							while (true)
							{
								...
								case 0u:
									goto end_IL_01d9;
								case 5u:
									return Class171.smethod_128(this, new AccessViolationException("Unable to write memory for the PE section."));
								}
								goto IL_021a;
								continue;
								end_IL_01d9:
	...
	internal static byte[] smethod_7(Class154 class154_0)
	{
