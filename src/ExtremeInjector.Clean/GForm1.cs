...
public sealed class GForm1 : Form
{
	public sealed class Class32
	{
		...
		{
			method_1(checkBox_1);
			method_3(typeof(InjectorScrambleOptions).GetFields().First((FieldInfo fieldInfo_0) => fieldInfo_0.GetCustomAttributes(inherit: false).Any((object object_0) => object_0 is DataMemberAttribute && ((DataMemberAttribute)object_0).Name == string_0)));
		}
	...
	public GForm1()
	{
		...
		{
			new Class32("ScrambleHeaderFields", checkBox_0),
			new Class32("RemoveUselessData", checkBox_1),
			new Class32("InsertExtraSections", checkBox_3),
			new Class32("ShiftSectionData", checkBox_2),
			new Class32("ModifyAssemblyCode", checkBox_4),
			new Class32("RenameSections", checkBox_5),
			new Class32("CreateNewEntryPoint", checkBox_6),
			new Class32("ModifyImportTable", checkBox_8),
			new Class32("RemoveDebugData", checkBox_10),
			new Class32("MoveRelocationTable", checkBox_7),
			new Class32("CreateFakeDebugDirectory", checkBox_9),
			new Class32("ShiftSectionMemory", checkBox_12),
			new Class32("StripSectionCharacteristics", checkBox_11)
		});
		Class171.smethod_237(this);
	}
