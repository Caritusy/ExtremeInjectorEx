...
public sealed class Class90 : Class85
{
	...
	public override IntPtr method_0BA6(string string_0)
	{
		...
		while (true)
		{
			...
			continue;
			IL_0173:
			GClass1 gclass1_ = Class171.smethod_42(method_19())["kernel32.dll"] ?? throw new FileNotFoundException("Unable to find kernel32.dll in the specified process.");
			intPtr2 = Class171.smethod_225(gclass1_, "LoadLibraryW", bool_0: false);
			if (!(intPtr2 == IntPtr.Zero))
			{
				intPtr3 = Class171.smethod_225(gclass1_, "GetLastError", bool_0: false);
				num = 277739124;
				continue;
			}
