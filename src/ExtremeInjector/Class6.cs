...
internal class Class6 : Class5
{
	...
	protected virtual bool vmethod_1()
	{
		...
		while (true)
		{
			...
			case 10u:
			{
				int num4;
				int num5;
				if (Class171.smethod_265(ref class161_, (Class5)this))
				{
					num4 = 1301588511;
					num5 = 1301588511;
				}
			...
			int num6;
			if (num3 < class161_.method_1().method_2())
			{
				num = -175537422;
				num6 = -175537422;
			}
	...
	public static Class154 smethod_0<T>(Stream stream_0, bool bool_0 = false, Enum39 enum39_0 = Enum39.const_0) where T : Class6
	{
	...
	public static Class154 smethod_1<T>(Stream stream_0, string string_0, bool bool_0 = false, Enum39 enum39_0 = Enum39.const_0) where T : Class6
	{
	...
	public static Class154 smethod_2(Stream stream_0, bool bool_0 = false, Enum39 enum39_0 = Enum39.const_0)
	{
	...
	public static Class154 smethod_3(Stream stream_0, string string_0, bool bool_0 = false, Enum39 enum39_0 = Enum39.const_0)
	{
