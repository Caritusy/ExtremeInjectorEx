...
internal static class Class124
{
	...
	public struct Struct37(int int_4, int int_5, int int_6, int int_7)
	{
		...
		{
			return string.Format(CultureInfo.CurrentCulture, Class178.smethod_0(31210), int_0, int_1, int_2, int_3);
		}
	}
