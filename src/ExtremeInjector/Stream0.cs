...
internal sealed class Stream0 : Stream, Interface0
{
	...
	public Stream0(GClass2 gclass2_0, IntPtr intptr_2, Enum15 enum15_1, long long_2 = -1L)
	...
	public Stream0(IntPtr intptr_2, IntPtr intptr_3, Enum15 enum15_1, long long_2 = -1L)
	{
	...
	unsafe int Stream.Read(byte[] buffer, int offset, int count)
	{
	...
	unsafe void Stream.Write(byte[] buffer, int offset, int count)
	{
