...
internal sealed class Class154 : IDisposable
{
	...
	private sealed class Class155 : Interface3
	{
		public long imethod_0(Class154 class154_0, uint uint_0)
		{
			using (List<GClass5>.Enumerator enumerator = class154_0.method_8().GetEnumerator())
			{
				...
				while (true)
				{
					...
					{
						uint num3;
						switch ((num3 = (uint)(num ^ -813529743)) % 8)
						{
						case 7u:
						{
							int num6;
							int num7;
							if (uint_0 < current.method_4() + current.method_6())
							{
								num6 = 1961237498;
								num7 = 1961237498;
							}
							...
							num = num6 ^ (int)(num3 * 840203914);
							continue;
						}
						case 5u:
							result = uint_0 - current.method_4() + current.method_8();
							num = (int)((num3 * 312627368) ^ 0x285EE639);
							continue;
						case 3u:
						{
							int num4;
							int num5;
							if (uint_0 >= current.method_4())
							{
								num4 = 81893455;
								num5 = 81893455;
							}
	...
	private sealed class Class156 : Interface3
	{
		public long imethod_0(Class154 class154_0, uint uint_0)
		{
			return uint_0;
	...
	[SpecialName]
	[CompilerGenerated]
	private void method_29(Stream stream_1)
	{
		stream_0 = stream_1;
	}
	...
	[SpecialName]
	[CompilerGenerated]
	private void method_30(Enum39 enum39_1)
	{
		enum39_0 = enum39_1;
	}
