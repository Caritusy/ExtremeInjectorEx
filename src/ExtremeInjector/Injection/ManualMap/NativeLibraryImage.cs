...
public sealed class NativeLibraryImage
{
	...
	public IntPtr method_2(string string_0)
	{
		...
		{
			ExportedSymbol current = default(ExportedSymbol);
			while (true)
			{
				int num = 742339305;
				while (true)
				{
					...
					default:
					{
						using (List<ExportedSymbol>.Enumerator enumerator = class154_0.method_14().list_1.GetEnumerator())
						{
							while (true)
							{
								IL_013c:
								...
								while (true)
								{
									...
									case 3u:
										...
										continue;
									case 2u:
										num3 = ((!(current.method_4() == string_0)) ? 2130847947 : 1251945299) ^ ((int)num2 * -1862742474);
										continue;
									default:
										goto end_IL_0100;
									case 1u:
	...
	{
		method_1(RecoveredRuntime.VirtualAlloc((IntPtr)(long)class154_0.method_6().method_3().imethod_17(), (UIntPtr)class154_0.method_6().method_3().imethod_29(), NativeTypes.Enum33.flag_0 | NativeTypes.Enum33.flag_1, NativeTypes.Enum34.flag_6));
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 5u:
					method_1(RecoveredRuntime.VirtualAlloc(IntPtr.Zero, (UIntPtr)class154_0.method_6().method_3().imethod_29(), NativeTypes.Enum33.flag_0 | NativeTypes.Enum33.flag_1, NativeTypes.Enum34.flag_6));
				...
				default:
					{
						Stream stream = RecoveredRuntime.smethod_264(class154_0, 0L, num3);
						try
						{
									...
									while (true)
									{
										...
										while (true)
										{
											...
											case 1u:
												break;
											case 2u:
												throw new Exception("The TLS callback function at 0x" + ptr.ToString("X") + " returned FALSE.");
											case 0u:
												goto end_IL_03b9;
											}
											goto IL_03f6;
							...
							while (true)
							{
								...
								while (true)
								{
									...
									case 3u:
										break;
									case 5u:
										throw new Exception("The entry point function returned FALSE.");
									case 1u:
										return;
									}
									break;
	...
	internal void method_4()
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 15u:
				{
					num = (RecoveredRuntime.VirtualProtect(intPtr, (UIntPtr)current.method_2(), @enum, out var _) ? (-589755059) : (-1977212153));
					continue;
				}
				case 14u:
					current = enumerator.Current;
				...
				case 12u:
					...
					continue;
				case 11u:
					flag2 = (current.method_18() & SectionCharacteristics.flag_32) == SectionCharacteristics.flag_32;
				...
				case 6u:
					...
					continue;
				case 5u:
					num = (((current.method_18() & SectionCharacteristics.flag_29) == SectionCharacteristics.flag_29) ? 367274172 : 21435023) ^ ((int)num2 * -1919896556);
					continue;
				case 4u:
					...
					continue;
				case 2u:
					RecoveredRuntime.VirtualFree(intPtr, (UIntPtr)current.method_2(), NativeTypes.Enum28.const_0);
					num = (int)(num2 * 1710128443) ^ -1352362481;
					continue;
				case 1u:
					num = (((current.method_18() & SectionCharacteristics.flag_28) == SectionCharacteristics.flag_28) ? 89184410 : 1989304220) ^ ((int)num2 * -1708357636);
					continue;
				case 0u:
					flag = (current.method_18() & SectionCharacteristics.flag_33) == SectionCharacteristics.flag_33;
				...
				case 9u:
					break;
				case 3u:
					throw new AccessViolationException("Unable to change the protection of the section, '" + current.method_0() + "'.");
				case 7u:
					return;
				}
				break;
	...
	internal void method_5(ImportDirectory class148_0)
	{
		...
		while (true)
		{
					...
					while (true)
					{
						...
						while (true)
						{
							...
							case 8u:
								break;
							case 5u:
								throw new MissingMethodException("Unable to find the function '" + text2 + "' inside the module, '" + text + "'.");
							case 0u:
								goto end_IL_0137;
								IL_008c:
								text2 = text3;
								procAddress = RecoveredRuntime.GetProcAddress(intPtr2, text2);
			...
			case 12u:
				...
				intPtr2 = RecoveredRuntime.LoadLibrary(text);
				num = (int)(num2 * 135139657) ^ -1901204117;
				continue;
			case 11u:
				intPtr = RecoveredRuntime.CreateActCtx(ref struct50_);
			...
			case 9u:
				...
				@struct = new NativeTypes.Struct50
				{
					int_0 = Marshal.SizeOf(typeof(NativeTypes.Struct50))
				};
			...
			case 3u:
				...
				continue;
			case 2u:
				RecoveredRuntime.ActivateActCtx(intPtr, out intptr_);
			...
			case 6u:
				{
					throw new DllNotFoundException("Unable to load the module '" + text + "'. Make sure the file exists and try again.");
				}
				IL_028a:
				num4 = 1738503077;
				goto IL_025d;
				...
				while (true)
				{
					...
					{
					case 5u:
						num4 = ((!(intPtr != NativeTypes.intptr_0)) ? (-1703510730) : (-1010767337)) ^ ((int)num2 * -745611041);
						continue;
					case 2u:
						RecoveredRuntime.DeactivateActCtx(0, intptr_);
						num4 = (int)(num2 * 932969794) ^ -425408292;
						continue;
					case 1u:
						break;
					case 0u:
						RecoveredRuntime.ReleaseActCtx(intPtr);
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 3u:
						...
						continue;
					case 2u:
						num2 = ((current2.method_2() == BaseRelocationType.Dir64) ? 1455383491 : 2138725752) ^ (int)(num3 * 1819977700);
						continue;
					case 1u:
						num2 = ((current2.method_2() == BaseRelocationType.HighLow) ? (-636323674) : (-1863859338)) ^ ((int)num3 * -591222589);
						continue;
					case 0u:
						num2 = 518109338;
						continue;
		...
		while (enumerator.MoveNext())
		{
			while (true)
			{
				...
				while (true)
				{
					...
					{
					case 4u:
						intPtr = RecoveredRuntime.VirtualAlloc(method_0().smethod_9(current.method_4()), (UIntPtr)current.method_2(), NativeTypes.Enum33.flag_0, NativeTypes.Enum34.flag_6);
				...
				continue;
				IL_00b9:
				IntPtr destination = RecoveredRuntime.VirtualAlloc(method_0().smethod_9(current.method_4()), (UIntPtr)current.method_6(), NativeTypes.Enum33.flag_0, NativeTypes.Enum34.flag_6);
