...
public abstract class RemoteMemoryAccessor
{
	...
	protected virtual void vmethod_0(IntPtr intptr_1, IntPtr intptr_2, UIntPtr uintptr_0, out UIntPtr uintptr_1)
	{
		...
		goto IL_003f;
		IL_00a8:
		num = (RecoveredRuntime.ReadProcessMemory(method_2(), intptr_1, intptr_2, uintptr_0, out uintptr_1) ? (-2031890754) : (-881388508));
		goto IL_0068;
	}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 3u:
					...
					continue;
				case 1u:
					num3 = RecoveredRuntime.smethod_232(type_0);
		...
		if (!(result = vmethod_1(intptr_1, intptr_2, uintptr_0)))
		{
			...
			while (true)
			{
				...
				while (true)
				{
					...
					{
					case 7u:
						num = (vmethod_3(intptr_2, (long)(ulong)uintptr_0, NativeTypes.Enum34.flag_2, out enum34_) ? (-1329699852) : (-1499714597)) ^ ((int)num2 * -1791973513);
						continue;
					case 6u:
					...
					case 0u:
						break;
					case 5u:
						throw new AccessViolationException("Unable to write buffer to the specified pointer.");
					default:
						goto end_IL_010a;
					}
					break;
