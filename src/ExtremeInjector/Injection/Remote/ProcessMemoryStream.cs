...
public sealed class ProcessMemoryStream : Stream, ILengthValidator
{
			...
			if (bool_0)
			{
				while (true)
				{
					...
					while (true)
					{
						...
						{
						case 1u:
							num = ((enum15_0 == ProcessMemoryAccess.const_0) ? (-1832543292) : (-1628139131)) ^ ((int)num2 * -1883396110);
							continue;
						case 2u:
							break;
						case 0u:
							return true;
						case 4u:
							return enum15_0 == ProcessMemoryAccess.const_2;
						default:
							goto end_IL_0056;
						}
						break;
			...
			if (bool_0)
			{
				while (true)
				{
					...
					while (true)
					{
						...
						{
						case 1u:
							num = ((enum15_0 == ProcessMemoryAccess.const_1) ? 1188335210 : 1517287185) ^ ((int)num2 * -1992095951);
							continue;
						case 0u:
							break;
						case 2u:
	...
	protected override void Dispose(bool disposing)
	{
		...
		while (true)
		{
			...
			case 1u:
				...
				continue;
			case 0u:
				RecoveredRuntime.CloseHandle(intptr_0);
	...
	public unsafe override int Read(byte[] buffer, int offset, int count)
	{
		...
		while (true)
		{
					...
					fixed (byte* ptr = &array[0])
					{
						...
						while (true)
						{
							...
							case 17u:
								...
								continue;
							case 16u:
								num = (RecoveredRuntime.ReadProcessMemory_1(intptr_0, intptr_1.smethod_9(long_1), ptr + offset, (UIntPtr)(ulong)num5, &uIntPtr) ? 1718637327 : 1215664866);
								continue;
							case 15u:
							...
							case 1u:
								throw new ArgumentException("Offset and length are out of the bounds of the array.");
							default:
								return num4;
							case 5u:
								throw new InvalidOperationException("Read is currently not supported.");
							case 10u:
			...
			continue;
			IL_00d7:
			num = (RecoveredRuntime.ReadProcessMemory_1(intptr_0, intptr_1.smethod_9(long_1), (byte*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref reference) + offset, (UIntPtr)(ulong)num5, &uIntPtr) ? 1718637327 : 1215664866);
			continue;
			IL_0165:
			num = ((!CanRead) ? 776692189 : 983408507);
			continue;
	...
	public unsafe override void Write(byte[] buffer, int offset, int count)
	{
		...
		while (true)
		{
					...
					fixed (byte* ptr = &array[0])
					{
						...
						while (true)
						{
							...
							case 21u:
								...
								continue;
							case 19u:
								RecoveredRuntime.VirtualProtectEx(intptr_0, intptr_1.smethod_9(long_1), (UIntPtr)(ulong)count, enum34_, out enum34_);
								num = ((int)num3 * -399409082) ^ -684171031;
								continue;
							case 18u:
								flag = RecoveredRuntime.WriteProcessMemory_1(intptr_0, intptr_1.smethod_9(long_1), ptr + offset, (UIntPtr)(ulong)count, &uIntPtr);
							...
							case 14u:
								goto end_IL_003a;
							case 11u:
								num7 = (flag = RecoveredRuntime.WriteProcessMemory_1(intptr_0, intptr_1.smethod_9(long_1), ptr + offset, (UIntPtr)(ulong)count, &uIntPtr));
							...
							case 7u:
								...
								continue;
							case 5u:
								num4 = ((!RecoveredRuntime.VirtualProtectEx(intptr_0, intptr_1.smethod_9(long_1), (UIntPtr)(ulong)count, NativeTypes.Enum34.flag_2, out enum34_)) ? (-149352974) : (-1105346113));
							...
							case 12u:
								throw new ArgumentOutOfRangeException("offset");
							case 13u:
								throw new InvalidOperationException("Write is currently not supported.");
							case 17u:
								throw new ArgumentNullException("buffer");
							case 20u:
								throw new AccessViolationException();
			...
			case 19u:
				...
				continue;
			case 18u:
				flag = RecoveredRuntime.WriteProcessMemory_1(intptr_0, intptr_1.smethod_9(long_1), (byte*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref reference) + offset, (UIntPtr)(ulong)count, &uIntPtr);
				num = ((int)num3 * -1191710251) ^ 0x646714D;
				continue;
			case 16u:
				num5 = ((array.Length == 0) ? 1701273162 : 524776130);
			...
			continue;
			IL_012a:
			num7 = (flag = RecoveredRuntime.WriteProcessMemory_1(intptr_0, intptr_1.smethod_9(long_1), (byte*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref reference) + offset, (UIntPtr)(ulong)count, &uIntPtr));
			num = ((!num7) ? (-384108756) : (-477288837));
			continue;
			IL_01c8:
			num = ((buffer.Length - offset < count) ? (-740929808) : (-2102421327));
