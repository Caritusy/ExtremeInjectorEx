...
public class ImportDirectory
{
	...
	internal ImportDirectory(BoundsCheckedBinaryReader class5_0, PeImage class154_0)
	{
		...
		List<ImportedSymbol> collection = default(List<ImportedSymbol>);
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 25u:
					...
					continue;
				case 24u:
					collection = RecoveredRuntime.smethod_162(class5_0, this, class154_0);
				...
				case 20u:
					...
					continue;
				case 18u:
					num4 = RecoveredRuntime.smethod_135(class154_0, @class.method_4());
				...
				case 10u:
					...
					continue;
				case 9u:
					gclass0_0[text].AddRange(RecoveredRuntime.smethod_412(text, @class.method_8(), this));
					num = ((int)num2 * -1556872968) ^ -377113697;
					continue;
				case 8u:
					num3 = RecoveredRuntime.smethod_135(class154_0, @class.method_6());
					RecoveredRuntime.smethod_157(class5_0, num3);
				...
				case 2u:
					...
					continue;
				case 1u:
					gclass0_0.imethod_0(text, new List<string>(RecoveredRuntime.smethod_412(text, @class.method_8(), this)));
					num = -784129433;
					continue;
				case 0u:
					num3 = RecoveredRuntime.smethod_135(class154_0, @class.method_0());
