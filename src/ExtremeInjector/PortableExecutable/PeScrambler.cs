...
public sealed class PeScrambler : IDisposable
{
		...
		public Class132(PeSectionHeader gclass5_2, uint uint_2, uint uint_3)
		{
			while (true)
			{
				...
				while (true)
				{
					...
					case 4u:
					{
						PeSectionHeader gClass3 = method_3();
					...
					case 2u:
					{
						PeSectionHeader gClass2 = method_3();
	...
	public sealed class Class136 : IEnumerable<ResourceDirectoryNode>, IEnumerator<ResourceDirectoryNode>, IDisposable, IEnumerator, IEnumerable
	{
		...
		bool IEnumerator.MoveNext()
		{
			...
			while (true)
			{
				...
				default:
				{
					using (List<ResourceDirectoryNode>.Enumerator enumerator = class138_3.method_6().GetEnumerator())
					{
						while (true)
						{
							IL_0147:
			...
			IL_01ac:
			int_0 = -1;
			stack_0 = new Stack<ResourceDirectoryNode>();
			num2 = 1392490732;
			goto IL_0173;
		}
	...
	internal void method_0()
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 1u:
				{
					PeSectionHeader current = enumerator.Current;
					current.method_19((SectionCharacteristics)((uint)current.method_18() & 0xFFFFFF1Fu));
					num = -2031008082;
					continue;
				}
				default:
	...
	internal void method_1()
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 10u:
					@class.string_0 = RecoveredRuntime.smethod_273(this);
				...
				case 4u:
					...
					continue;
				case 3u:
					string_ = RecoveredRuntime.smethod_273(this);
	...
	internal void method_2()
	{
		...
		while (true)
		{
			...
			goto IL_01cf;
			IL_01fd:
			PeSectionHeader gClass = current;
			...
			while (true)
			{
				...
				case 4u:
					...
					continue;
				case 3u:
					RecoveredRuntime.smethod_437(this, current.method_8(), num);
			...
			goto IL_01ca;
			IL_0072:
			Stream stream = RecoveredRuntime.smethod_264(class154_0, current.method_8(), (int)(class154_0.method_28().Length - current.method_8()));
			try
			{
		...
		while (enumerator.MoveNext())
		{
			while (true)
			{
				...
				while (true)
				{
					...
					continue;
					IL_00c1:
					Stream stream = RecoveredRuntime.smethod_264(class154_0, current.method_8(), (int)current.method_6());
					try
					{
						BinaryReader binaryReader = new BinaryReader(stream);
						try
											...
											while (true)
											{
												...
												while (true)
												{
													...
													case 1u:
													{
														...
														RecoveredRuntime.smethod_437(this, current2.Key, current2.Value);
														num4 = -242992493;
														continue;
													}
													default:
					...
					continue;
					IL_0040:
					if ((current.method_18() & SectionCharacteristics.flag_32) != SectionCharacteristics.flag_32)
					{
						goto end_IL_00a9;
					}
	...
	internal void method_4()
	{
		...
		PeSectionHeader current2 = default(PeSectionHeader);
		int num22 = default(int);
		uint uint_2 = default(uint);
		uint num21 = default(uint);
		PeSectionHeader gClass3 = default(PeSectionHeader);
		SectionCharacteristics @enum = default(SectionCharacteristics);
		...
		SectionCharacteristics[] array = default(SectionCharacteristics[]);
		PeSectionHeader gClass2 = default(PeSectionHeader);
		while (true)
		{
			int num = 1700781662;
			while (true)
			{
				...
				default:
					...
					while (true)
					{
						...
						default:
						{
							Stream stream = RecoveredRuntime.smethod_264(class154_0, num4, (int)(class154_0.method_28().Length - num4));
							byte[] buffer;
							try
							{
								BinaryReader binaryReader = new BinaryReader(stream);
							...
							RecoveredRuntime.smethod_377(this, num6, num10 - num6);
							...
							using (List<PeSectionHeader>.Enumerator enumerator = class154_0.method_8().GetEnumerator())
							{
								while (true)
								{
									...
									while (true)
									{
										...
										case 0u:
										{
											PeSectionHeader gClass = current2;
							...
							{
								Stream stream2 = RecoveredRuntime.smethod_264(class154_0, num11, (int)(class154_0.method_28().Length - num11));
								try
								{
							...
							while (true)
							{
								...
								while (true)
								{
									...
									{
									case 60u:
										num12 = RecoveredRuntime.smethod_201(uint_, num12);
									...
									case 54u:
										...
										num21 = RecoveredRuntime.smethod_201(uint_, gClass3.method_2());
										num16 = (int)((num2 * 1270102669) ^ 0x49C0FC29);
										continue;
									case 53u:
										RecoveredRuntime.smethod_41(gClass3, this);
									...
									case 45u:
										...
										continue;
									case 44u:
										RecoveredRuntime.smethod_437(this, gClass3.method_8(), gClass3.method_6());
									...
									case 32u:
										...
										continue;
									case 31u:
										gClass3.method_7(RecoveredRuntime.smethod_201(uint_2, num21));
										array = new SectionCharacteristics[4]
										{
											SectionCharacteristics.flag_34,
									...
									case 30u:
										...
										continue;
									case 29u:
										class154_0.method_6().method_3().imethod_30(RecoveredRuntime.smethod_201(uint_, gClass2.method_4() + gClass2.method_2()));
									...
									case 8u:
										...
										continue;
									case 7u:
										RecoveredRuntime.smethod_284(this, gClass3);
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 2u:
					...
					continue;
				case 1u:
					RecoveredRuntime.smethod_437(this, gclass5_0.method_8(), gclass5_0.method_6());
				...
				default:
					{
						using (List<PeSectionHeader>.Enumerator enumerator = class154_0.method_8().GetEnumerator())
						{
							while (true)
							{
								...
								while (true)
								{
									...
									case 5u:
									{
										PeSectionHeader gClass = @class.method_3();
									...
									case 1u:
									{
										...
										num6 = RecoveredRuntime.smethod_201(uint_2, uint_);
						...
						PeSectionHeader gClass2 = new PeSectionHeader();
						gClass2.method_19(SectionCharacteristics.flag_33);
						gClass2.method_5(class154_0.method_8()[0].method_4());
						gClass2.method_3(num4);
						gClass2.method_1(RecoveredRuntime.smethod_273(this));
	...
	internal void method_7(List<Class132> list_0)
	{
		...
		class154_0.method_28().Position = RecoveredRuntime.smethod_135(class154_0, class154_0.method_6().method_3().imethod_49()[1].method_0());
		using List<ImportDescriptor>.Enumerator enumerator = class154_0.method_10().list_0.GetEnumerator();
		ImportDescriptor current = default(ImportDescriptor);
		long position = default(long);
		ImportedSymbol current2 = default(ImportedSymbol);
		ImportedSymbol current3 = default(ImportedSymbol);
		while (true)
		{
			IL_056a:
			if (enumerator.MoveNext())
			{
				while (true)
				{
					...
					while (true)
					{
						...
						case 6u:
							...
							continue;
						case 5u:
							binaryWriter.Write(RecoveredRuntime.smethod_33(list_0, current.method_6()));
							position = class154_0.method_28().Position;
							class154_0.method_28().Position = RecoveredRuntime.smethod_135(class154_0, current.method_0());
							num = ((int)num2 * -857508609) ^ -1702002374;
							continue;
						case 2u:
							binaryWriter.Write(RecoveredRuntime.smethod_33(list_0, current.method_0()));
						...
						case 1u:
							...
							continue;
						case 0u:
							binaryWriter.Write(RecoveredRuntime.smethod_33(list_0, current.method_4()));
				...
				using (List<ImportedSymbol>.Enumerator enumerator2 = current.method_8().GetEnumerator())
				{
					while (true)
					{
						IL_02ff:
						...
						while (true)
						{
							...
							case 7u:
								...
								continue;
							case 6u:
								num3 = (RecoveredRuntime.smethod_19(class154_0) ? (-752147151) : (-236609310));
								continue;
							case 5u:
								class154_0.method_28().Position += (RecoveredRuntime.smethod_19(class154_0) ? 4 : 8);
								num3 = -2129259869;
								continue;
							case 3u:
							{
								ulong num4;
								current2.method_1(num4 = RecoveredRuntime.smethod_33(list_0, (uint)current2.method_0()));
				...
				{
					class154_0.method_28().Position = RecoveredRuntime.smethod_135(class154_0, current.method_6());
					using List<ImportedSymbol>.Enumerator enumerator2 = current.method_10().GetEnumerator();
					while (true)
					{
						IL_04c5:
						...
						while (true)
						{
							...
							{
								ulong num4;
								current3.method_1(num4 = RecoveredRuntime.smethod_33(list_0, (uint)current3.method_0()));
								binaryWriter.Write((uint)num4);
								num5 = ((int)num2 * -701778638) ^ 0x68B0BDC2;
								continue;
							}
							case 8u:
								num5 = ((!RecoveredRuntime.smethod_19(class154_0)) ? (-997255661) : (-153582566));
								continue;
							case 7u:
								num5 = -232663685;
								continue;
				...
				current.method_1(RecoveredRuntime.smethod_33(list_0, current.method_0()));
				current.method_5(RecoveredRuntime.smethod_33(list_0, current.method_4()));
				goto IL_055c;
			}
			int num6 = -846042793;
			goto IL_053a;
			...
			while (true)
			{
				...
				{
				case 1u:
					current.method_7(RecoveredRuntime.smethod_33(list_0, current.method_6()));
	...
	internal void method_8(List<Class132> list_0)
	{
		...
		default:
		{
			class154_0.method_28().Position = RecoveredRuntime.smethod_135(class154_0, class154_0.method_6().method_3().imethod_49()[3].method_0());
			using List<RuntimeFunctionEntry>.Enumerator enumerator = class154_0.method_25().list_0.GetEnumerator();
			RuntimeFunctionEntry current = default(RuntimeFunctionEntry);
			while (true)
			{
				...
				while (true)
				{
					...
					case 4u:
					{
						...
						uint value;
						current.method_3(value = RecoveredRuntime.smethod_33(list_0, current.method_2()));
					...
					case 2u:
					{
						...
						uint value;
						current.method_1(value = RecoveredRuntime.smethod_33(list_0, current.method_0()));
					...
					case 0u:
					{
						...
						uint value;
						current.method_5(value = RecoveredRuntime.smethod_33(list_0, current.method_4()));
	...
	internal void method_9(List<Class132> list_0)
	{
		...
		while (true)
		{
			...
			{
			case 4u:
				num3 = RecoveredRuntime.smethod_135(class154_0, class154_0.method_6().method_3().imethod_49()[5].method_0());
			...
			default:
			{
				using List<BaseRelocationBlock>.Enumerator enumerator = class154_0.method_16().list_0.GetEnumerator();
				while (true)
				{
					if (enumerator.MoveNext())
					{
						BaseRelocationBlock current = enumerator.Current;
						...
						using (List<BaseRelocationEntry>.Enumerator enumerator2 = current.list_0.GetEnumerator())
						{
							while (true)
							{
								...
								while (true)
								{
									...
									{
									case 10u:
										num4 = ((current2.method_2() == BaseRelocationType.Dir64) ? (-204465497) : (-848775079));
										continue;
									case 9u:
										binaryWriter.Write((uint)(int)num5 + RecoveredRuntime.smethod_33(list_0, num6 - (uint)(int)num5));
									...
									case 3u:
										...
										continue;
									case 2u:
										class154_0.method_28().Position = RecoveredRuntime.smethod_135(class154_0, current.method_0() + current2.method_0());
										num4 = ((int)num2 * -37649823) ^ 0x49CF5D8C;
										continue;
									case 1u:
										binaryWriter.Write(num5 + RecoveredRuntime.smethod_33(list_0, (uint)(num7 - num5)));
										num4 = ((int)num2 * -1411925062) ^ -106864037;
										continue;
									case 0u:
										num4 = ((current2.method_2() != BaseRelocationType.HighLow) ? 813692528 : 1878221062) ^ (int)(num2 * 1736278061);
										continue;
									default:
										goto end_IL_02b2;
									case 11u:
