...
internal sealed class Class94 : Class82, IDisposable
{
	[CompilerGenerated]
	...
	public void method_19(IntPtr intptr_1)
	{
		...
		while (true)
		{
			...
			IL_00b6:
			int num5;
			if (!method_14(intptr_1, struct47_.intptr_2.ToInt64(), enum34_))
			{
				num = -1669067430;
				num5 = -1669067430;
			}
			...
			IL_0060:
			int num6;
			if (vmethod_3(intptr_1, struct47_.intptr_2.ToInt64(), Class124.Enum34.flag_6, out enum34_))
			{
				num = -86638083;
				num6 = -86638083;
			}
		...
		IL_0134:
		int num7;
		if (Class124.VirtualQueryEx(method_2(), intptr_1, out struct47_, (uint)Class124.int_0) != 0)
		{
			num = -1944830856;
			num7 = -1944830856;
		}
