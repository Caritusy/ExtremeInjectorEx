...
public sealed class ManualMapOptionsForm : Form
{
	...
	internal void method_2(object sender, EventArgs e)
	{
		...
		while (true)
		{
			...
			case 5u:
				...
				continue;
			case 4u:
				num = ((MessageBox.Show(UiText.Get("Message.ManualMapDisableExceptions"), UiText.Get("App.Title"), MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.No) ? (-1116613047) : (-1888268518)) ^ ((int)num2 * -1675529366);
				continue;
			case 2u:
	...
	internal void method_3(object sender, EventArgs e)
	{
		...
		while (true)
		{
			...
			{
			case 5u:
				num = ((MessageBox.Show(UiText.Get("Message.ManualMapDisableSeh"), UiText.Get("App.Title"), MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) != DialogResult.No) ? 756122273 : 75688510) ^ ((int)num2 * -387340463);
				continue;
			case 4u:
				break;
			case 2u:
