...
public sealed partial class ModuleOptionsForm : Form
{
	...
	internal void method_4(object sender, EventArgs e)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				default:
					{
						using (List<ExportedSymbol>.Enumerator enumerator = method_2().method_14().list_1.GetEnumerator())
						{
							while (true)
							{
								IL_0194:
								...
								while (true)
								{
									...
									while (true)
									{
										...
										case 3u:
											...
											continue;
										case 2u:
											RecoveredRuntime.smethod_342(this, current2.Value, current2.Type, bool_0: false);
	...
	internal void method_7(object sender, EventArgs e)
	{
		...
		goto IL_0037;
		IL_006d:
		num = (RecoveredRuntime.smethod_342(this, textBox_0.Text, (ExportParameterType)comboBox_2.SelectedIndex, bool_0: true) ? 1795704142 : 692908412);
		goto IL_003c;
	}
