...
public sealed partial class SettingsForm : Form
{
	...
	internal void method_11(object sender, EventArgs e)
	{
		...
		openFileDialog.Filter = UiText.Get("Dialog.DllFilter");
			...
			try
			{
				PeImage @class = RecoveredRuntime.smethod_81(PeImageLayout.const_0, openFileDialog.FileName);
				try
				{
					if (@class == null)
					{
					...
					PeScrambleOptions class131_ = default(PeScrambleOptions);
					while (true)
					{
						int num3 = -1694884631;
						while (true)
						{
							...
							{
							case 1u:
								num8 = (((@class.method_6().method_1().method_12() & CoffCharacteristics.flag_12) != 0) ? 29459692 : 40628579);
								goto IL_00ef;
							case 2u:
								break;
							default:
								...
								try
								{
									...
									while (true)
									{
										...
										while (true)
										{
											...
											default:
											{
												PeScrambler gClass = new PeScrambler(@class, class131_);
												try
												{
	...
	{
		PeImage @class = RecoveredRuntime.smethod_81(PeImageLayout.const_0, Assembly.GetExecutingAssembly().Location);
		try
		{
			PeScrambleOptions class2 = new PeScrambleOptions();
			...
			try
			{
				...
				while (true)
				{
					...
					while (true)
					{
						...
						case 8u:
							RecoveredRuntime.smethod_185(encoding_, gClass, string_2);
							text = RecoveredRuntime.CreateUniqueTemporaryPath(".exe");
