public struct LzmaBitTreeDecoder(int int_1)
{
	...
	public uint method_2(LzmaRangeDecoder class190_0)
	{
		uint num = 1u;
		uint num2 = 0u;
	...
	public static uint smethod_0(LzmaBitDecoder[] struct86_1, uint uint_0, LzmaRangeDecoder class190_0, int int_1)
	{
		uint num = 1u;
		uint num2 = 0u;
