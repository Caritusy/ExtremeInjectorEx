...
internal abstract class Class84 : Class83
{
	...
	{
		return method_23<T>(class47_0.class53_0, IntPtr.Zero, class47_0.method_2());
	}

	protected internal T method_22<T>(Class47 class47_0, IntPtr intptr_1, bool bool_2 = true)
	{
		return method_23<T>(class47_0.class53_0, intptr_1, class47_0.method_2(), bool_2);
	}

	protected T method_23<T>(Class53 class53_0, IntPtr intptr_1, int int_1, bool bool_2 = true)
	{
