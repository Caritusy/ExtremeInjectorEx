...
{
	private class Class188
	{
		private Struct86 struct86_0;

		private Struct86 struct86_1;

		private Struct87 struct87_0 = new Struct87(8);

		private Struct87[] struct87_1 = new Struct87[16];

		private Struct87[] struct87_2 = new Struct87[16];
		...
		public void method_0(uint uint_1)
		{
			...
			{
				struct87_1[num] = new Struct87(3);
				struct87_2[num] = new Struct87(3);
			}
			uint_0 = uint_1;
		}
		...
		public uint method_2(Class190 class190_0, uint uint_1)
		{
	...
	private class Class189
	{
		private struct Struct85
		{
			private Struct86[] struct86_0;

			public void method_0()
			{
				struct86_0 = new Struct86[768];
			}
			...
			public byte method_2(Class190 class190_0)
			{
				uint num = 1u;
				do
				{
			...
			public byte method_3(Class190 class190_0, byte byte_0)
			{
				uint num = 1u;
				do
				{
		...
		public byte method_3(Class190 class190_0, uint uint_1, byte byte_0)
		{
			return struct85_0[method_2(uint_1, byte_0)].method_2(class190_0);
		}

		public byte method_4(Class190 class190_0, uint uint_1, byte byte_0, byte byte_1)
		{
			return struct85_0[method_2(uint_1, byte_0)].method_3(class190_0, byte_1);
		}
	}

	private const bool bool_0 = default(bool);

	private uint uint_0;

	private uint uint_1;

	private Struct86[] struct86_0 = new Struct86[192];

	private Struct86[] struct86_1 = new Struct86[192];

	private Struct86[] struct86_2 = new Struct86[12];

	private Struct86[] struct86_3 = new Struct86[12];

	private Struct86[] struct86_4 = new Struct86[12];

	private Struct86[] struct86_5 = new Struct86[12];
	...
	private Struct87 struct87_0 = new Struct87(4);

	private Struct86[] struct86_6 = new Struct86[114];

	private Struct87[] struct87_1 = new Struct87[4];

	private uint uint_2;

	private Class190 class190_0 = new Class190();

	private Class188 class188_1 = new Class188();
	...
	public void method_4(Stream stream_0, Stream stream_1, long long_0)
	{
		...
		Class191.Struct88 @struct = default(Class191.Struct88);
		@struct.method_0();
		uint num = 0u;
		uint num2 = 0u;
		uint num3 = 0u;
		...
		while (num5 < (ulong)long_0)
		{
			...
			else
			{
				...
				@struct.method_2();
				uint num9 = struct87_1[Class191.smethod_0(num8)].method_1(class190_0);
				if (num9 >= 4)
				{
					...
					if (num9 < 14)
					{
						num += Struct87.smethod_0(struct86_6, num - num9 - 1, class190_0, num10);
					}
					else
					{
