...
internal abstract class Class82
{
	[CompilerGenerated]
	private int int_0;
	...
	protected virtual void Class82_002E_202A_202C_202E_200F_202C_206C_200C_202D_202A_206E_200F_200C_202D_202C_202B_200C_206B_200D_206C_206F_206E_206D_206F_200D_200E_206A_202A_202B_202B_206B_200C_202D_202E_206D_202E_206E_200C_202E_200E_202E()
	{
		if (method_6() != null)
		{
			goto IL_009c;
	...
	protected virtual void vmethod_0(IntPtr intptr_1, IntPtr intptr_2, UIntPtr uintptr_0, out UIntPtr uintptr_1)
	{
		...
		IL_00a8:
		int num4;
		if (!Class171.ReadProcessMemory(method_2(), intptr_1, intptr_2, uintptr_0, out uintptr_1))
		{
			num = -881388508;
			num4 = -881388508;
		}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 11u:
				{
					...
					num = num7 ^ (int)(num2 * 2080664007);
					continue;
				}
				case 10u:
					method_9(intptr_1, intPtr, (UIntPtr)(ulong)num6);
					num = (int)((num2 * 152518604) ^ 0x7800FDCB);
					continue;
				case 9u:
					array2[num3] = (T)Marshal.PtrToStructure(intPtr.smethod_8(num3 * num5), typeFromHandle);
					num = 1359727763;
					continue;
				case 7u:
					num3++;
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 7u:
					{
						int num5;
						int num6;
						if (!vmethod_3(intptr_2, (long)(ulong)uintptr_0, Class124.Enum34.flag_2, out enum34_))
						{
							num5 = -1499714597;
							num6 = -1499714597;
						}
					...
					case 6u:
					{
						int num7;
						int num8;
						if (method_14(intptr_2, (long)(ulong)uintptr_0, enum34_))
						{
							num7 = 1165967935;
							num8 = 1165967935;
						}
					...
					case 2u:
					{
						int num3;
						int num4;
						if (vmethod_1(intptr_1, intptr_2, uintptr_0))
						{
							num3 = 864391181;
							num4 = 864391181;
						}
						...
						fixed (byte* ptr = &array2[0])
						{
							...
							while (true)
							{
								...
								case 8u:
									...
									num2 = num14 ^ (int)(num4 * 343084068);
									continue;
								case 7u:
									num8 = Class127.smethod_1<T>();
								...
								case 5u:
									goto end_IL_0076;
								case 3u:
									Marshal.StructureToPtr((object)gparam_0[num6], intPtr.smethod_8(num6 * num8), false);
									num2 = -447535127;
									continue;
								case 2u:
									if (array2.Length == 0)
