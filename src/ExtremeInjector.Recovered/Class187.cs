...
public static class Class187
{
	...
	private static Func<int, MethodBase> func_0;

	private static Delegate49 delegate49_0;
	...
	private static int smethod_0(this BinaryReader binaryReader_0)
	{
		return binaryReader_0.ReadInt32() ^ 0x28B4E8A0;
	}

	private static byte[] smethod_1(this BinaryReader binaryReader_0, int int_0)
	{
	...
	private static DynamicMethod smethod_3(BinaryReader binaryReader_0)
	{
	...
	private static string smethod_4(this BinaryReader binaryReader_0)
	{
		return Encoding.UTF8.GetString(smethod_1(binaryReader_0, smethod_0(binaryReader_0)));
	}

	private static Type smethod_5(BinaryReader binaryReader_0)
	{
		return smethod_6(binaryReader_0.ReadByte(), binaryReader_0);
	}

	private static Type smethod_6(byte byte_1, BinaryReader binaryReader_0)
	{
		if (byte_1 == 1)
		{
	...
	private static Type smethod_7(BinaryReader binaryReader_0, Type type_0)
	{
	...
	private static MethodBase smethod_9(byte byte_1, BinaryReader binaryReader_0)
	{
		Type type;
		Type[] array;
		string text;
	...
	private static MethodBase smethod_10(string string_0, int int_0, Type type_0, Type[] type_1)
	{
	...
	private static MethodBase smethod_11(BinaryReader binaryReader_0)
	{
