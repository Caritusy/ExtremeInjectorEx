...
public class Class62 : Class56
{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 4u:
					...
					continue;
				case 2u:
					struct9_ = Class171.smethod_188(this);
				...
				case 0u:
					...
					Class171.smethod_280(this, struct9_);
	...
	public override bool Equals(object obj)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 1u:
					num3 = ((!Class171.smethod_134(null, @class)) ? (-2137625157) : (-1864291848));
					goto IL_0028;
				case 2u:
					break;
				case 0u:
					return false;
				default:
					return Class171.smethod_338(this) == Class171.smethod_338(@class);
				}
				break;
				IL_0028:
	...
	{
		return Class171.smethod_338(this).GetHashCode();
	}
}
