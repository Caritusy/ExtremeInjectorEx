...
public sealed class Class88 : Class85
{
	...
	public override IntPtr method_0BA6(string string_0)
	{
		...
		while (true)
		{
			...
			continue;
			IL_012e:
			intPtr2 = Class171.smethod_225(Class171.smethod_42(method_19())[Class178.smethod_0(8549)] ?? throw new FileNotFoundException(Class178.smethod_0(12731)), Class178.smethod_0(28220), bool_0: false);
			num = -2108430739;
			continue;
			end_IL_0231:
			break;
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 1u:
					...
					Class171.smethod_320(class2, bytes);
					Class171.smethod_227(class47_);
