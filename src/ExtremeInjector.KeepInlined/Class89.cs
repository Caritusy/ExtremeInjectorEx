...
public sealed class Class89(GClass2 gclass2_1) : Class85(gclass2_1)
{
	...
	internal bool method_37(Class172 class172_0, uint uint_0)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 6u:
					{
						return Class171.smethod_128(this, new FileNotFoundException(Class178.smethod_0(12731)));
					}
					IL_03c6:
					...
					while (true)
					{
						...
						case 4u:
							goto IL_05cc;
						case 5u:
							return Class171.smethod_128(this, new AccessViolationException(Class178.smethod_0(29108)));
						default:
							return true;
						}
						break;
	...
	internal bool method_40()
	{
		...
		while (true)
		{
			...
			{
			case 30u:
				num = ((!Class171.smethod_340(Class178.smethod_0(29350), 0, array)) ? (-95892414) : (-469689408)) ^ (int)(num2 * 1775755729);
				continue;
			case 29u:
			...
			case 26u:
				break;
			case 25u:
				num = (((num3 = Class171.smethod_419(array, Class178.smethod_0(29429), Class178.smethod_0(29438), 0)) != -1) ? (-214482323) : (-2119293287)) ^ ((int)num2 * -149492349);
				continue;
			case 23u:
			{
			...
			case 22u:
				...
				continue;
			case 21u:
				num3 = Class171.smethod_419(array, Class178.smethod_0(29239), Class178.smethod_0(29260), 0);
			...
			case 10u:
				goto IL_039c;
			case 0u:
				return Class171.smethod_128(this, new AccessViolationException(Class178.smethod_0(29512)));
			case 1u:
				return Class171.smethod_128(this, new FileNotFoundException(Class178.smethod_0(12731)));
			case 4u:
				return Class171.smethod_128(this, new InvalidOperationException(Class178.smethod_0(29443)));
			case 6u:
				return Class171.smethod_128(this, new AccessViolationException(Class178.smethod_0(29589)));
			case 7u:
				return Class171.smethod_128(this, new InvalidOperationException(Class178.smethod_0(29359)));
			default:
				return true;
			case 16u:
				return Class171.smethod_128(this, new InvalidOperationException(Class178.smethod_0(29359)));
			...
			case 18u:
				return true;
			case 24u:
				return Class171.smethod_128(this, new InvalidOperationException(Class178.smethod_0(29277)));
			case 28u:
				return Class171.smethod_128(this, new MissingMethodException(Class178.smethod_0(29182)));
			}
			break;
			IL_0237:
			array = method_10<byte>(intptr_, 200);
			num = (((num3 = Class171.smethod_378(array, Class178.smethod_0(29424), 0)) == -1) ? (-1443517686) : (-1486477485));
			continue;
			IL_0170:
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 6u:
						...
						continue;
					case 5u:
						result = Class171.smethod_128(this, new AccessViolationException(Class178.smethod_0(29678)));
	...
	internal bool method_42(Class172 class172_0, Class148 class148_0)
	{
		...
		while (true)
		{
			...
			case 11u:
				goto IL_036f;
			case 5u:
				return Class171.smethod_128(this, new Exception(Class178.smethod_0(29755) + text));
			case 9u:
				return false;
			case 12u:
				{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 4u:
					break;
				case 0u:
					return Class171.smethod_128(this, new AccessViolationException(Class178.smethod_0(30255)));
				case 2u:
					return Class171.smethod_128(this, new AccessViolationException(Class178.smethod_0(30194)));
				default:
				{
						...
						while (true)
						{
							...
							while (true)
							{
								...
								case 0u:
									goto end_IL_01d9;
								case 5u:
									return Class171.smethod_128(this, new AccessViolationException(Class178.smethod_0(30316)));
								}
								goto IL_021a;
								continue;
								end_IL_01d9:
