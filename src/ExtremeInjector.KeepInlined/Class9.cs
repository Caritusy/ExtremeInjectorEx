...
public static class Class9
{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 40u:
					...
					ilgenerator_0.Emit(OpCodes.Call, method_1(typeof(Assembly), Class178.smethod_0(54), new Type[1] { typeof(byte[]) }));
				...
				case 36u:
					ilgenerator_0.smethod_1(localBuilder_);
					ilgenerator_0.Emit(OpCodes.Callvirt, method_0(typeof(string), Class178.smethod_0(41)));
					num = (int)((num2 * 1313657541) ^ 0x2BE1BF3D);
					continue;
				case 35u:
					ilgenerator_0.Emit(OpCodes.Ldloc, local);
					ilgenerator_0.Emit(OpCodes.Callvirt, method_1(typeof(MethodBase), Class178.smethod_0(84), new Type[2]
					{
						typeof(object),
						typeof(object[])
					}));
				...
				case 21u:
					...
					continue;
				case 20u:
					ilgenerator_0.Emit(OpCodes.Callvirt, method_0(typeof(Assembly), Class178.smethod_0(63)));
				...
				case 17u:
					...
					continue;
				case 16u:
					ilgenerator_0.Emit(OpCodes.Callvirt, method_0(typeof(string), Class178.smethod_0(24)));
	...
	{
		AssemblyName assemblyName = new AssemblyName(Class171.smethod_426());
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 14u:
					methodBuilder = typeBuilder.DefineMethod(Class171.smethod_426(), MethodAttributes.Public | MethodAttributes.Static, typeof(void), new Type[1] { typeof(string[]) });
