	...
	public override IntPtr Class85_002E_202A_202C_202E_200F_202C_206C_200C_202D_202A_206E_200F_200C_202D_202C_202B_200C_206B_200D_206C_206F_206E_206D_206F_200D_200E_206A_202A_202B_202B_206B_200C_202D_202E_206D_202E_206E_200C_202E_200E_202E(string string_0)
	{
		...
		while (true)
		{
			...
			case 21u:
				break;
			case 20u:
				intPtr = Class171.smethod_315(this, intptr_, IntPtr.Zero);
				num = (int)(num2 * 1880844593) ^ -102391197;
				continue;
			case 18u:
				Class171.smethod_152(this, intPtr, -1);
				num = -1569625463;
				continue;
			case 17u:
				vmethod_6(intptr_);
				...
				continue;
			case 14u:
				num = (Class171.smethod_296(method_19()) ? 1085827942 : 102433601) ^ (int)(num2 * 124969340);
				continue;
			case 10u:
			...
			continue;
			IL_012e:
			intPtr2 = Class171.smethod_220(Class171.smethod_42(method_19())[Class178.smethod_0(8549)] ?? throw new FileNotFoundException(Class178.smethod_0(12731)), Class178.smethod_0(28220), bool_0: false);
			num = -2108430739;
			continue;
			end_IL_0231:
			break;
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 18u:
					...
					num = ((Class171.smethod_434(intPtr, class2, this) == IntPtr.Zero) ? 1549379627 : 113368551) ^ ((int)num2 * -253945004);
					continue;
				case 17u:
					num = (Class171.smethod_418(method_19()) ? 1506205645 : 2023462491) ^ ((int)num2 * -904323616);
					continue;
				case 16u:
