...
public class Class6 : Class5
{
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 3u:
						...
						continue;
					case 1u:
						Class6_002E_202A_202C_202E_200F_202C_206C_200C_202D_202A_206E_200F_200C_202D_202C_202B_200C_206B_200D_206C_206F_206E_206D_206F_200D_200E_206A_202A_202B_202B_206B_200C_202D_202E_206D_202E_206E_200C_202E_200E_202E();
	...
	protected virtual bool vmethod_1()
	{
		...
		if (!Class171.smethod_435(ref class158_, this))
		{
			goto IL_0096;
		}
		goto IL_013e;
		...
		while (true)
		{
			...
			case 11u:
				break;
			case 10u:
				num = ((!Class171.smethod_265(ref class161_, this)) ? 441894260 : 1301588511) ^ (int)(num2 * 142451864);
				continue;
			case 9u:
			...
			case 2u:
				...
				continue;
			case 1u:
				Class171.smethod_200(this, class158_.method_0());
	...
	protected virtual void Class6_002E_202A_202C_202E_200F_202C_206C_200C_202D_202A_206E_200F_200C_202D_202C_202B_200C_206B_200D_206C_206F_206E_206D_206F_200D_200E_206A_202A_202B_202B_206B_200C_202D_202E_206D_202E_206E_200C_202E_200E_202E()
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
				case 5u:
					class154_0.method_17(Class171.smethod_224(class154_0, this));
					class154_0.method_24(Class171.smethod_383(class154_0, this));
					num = ((int)num2 * -283194504) ^ -234416842;
					continue;
				case 4u:
					class154_0.method_19(Class171.smethod_3(class154_0, this));
					class154_0.method_21(Class171.smethod_159(class154_0, this));
				...
				case 3u:
					...
					continue;
				case 1u:
					class154_0.method_13(Class171.smethod_287(this, class154_0));
					class154_0.method_15(Class171.smethod_349(class154_0, this));
					num = (int)(num2 * 56922965) ^ -1121016948;
					continue;
				case 0u:
					break;
				default:
					class154_0.method_26(Class171.smethod_297(class154_0, this));
					class154_0.method_27(Class171.smethod_306(class154_0, this));
					return;
				}
				break;
			}
