	...
	internal Class149(Class5 class5_0, Class154 class154_0)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 19u:
					ienumerable_ = Class171.smethod_161(class5_0, this, class154_0);
				...
				case 16u:
					...
					continue;
				case 15u:
					num3 = Class171.smethod_134(class154_0, num5);
					num = ((int)num2 * -180754170) ^ -954673433;
					continue;
				case 14u:
					gclass0_0[text].AddRange(Class171.smethod_404(text, ienumerable_, this));
				...
				case 9u:
					...
					continue;
				case 8u:
					num7 = Class171.smethod_134(class154_0, uint_);
					num = (int)((num2 * 1640284739) ^ 0x11A3AA21);
					continue;
				case 7u:
					gclass0_0.imethod_0(text, new List<string>(Class171.smethod_404(text, ienumerable_, this)));
					num = -1518140740;
					continue;
				case 6u:
