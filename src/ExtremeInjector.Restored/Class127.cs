		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 13u:
					...
					continue;
				case 12u:
					bool_1 = Class171.smethod_289(0, 0, 6, -1);
					bool_2 = Class171.smethod_289(1, 0, 6, -1);
					num = ((int)num2 * -734284144) ^ -1913130437;
					continue;
				case 11u:
					bool_11 = Class171.smethod_289(1, 0, 10, -1);
				...
				case 10u:
					...
					continue;
				case 9u:
					bool_3 = Class171.smethod_289(1, 2, 5, -1);
				...
				case 8u:
					...
					continue;
				case 7u:
					bool_4 = Class171.smethod_289(1, 3, 5, -1);
					num = (int)((num2 * 1941506399) ^ 0x455E538D);
					continue;
				case 6u:
					bool_6 = Class171.smethod_289(3, 0, 6, -1);
					bool_7 = Class171.smethod_289(0, 0, 10, -1);
					bool_8 = Class171.smethod_289(0, 0, 10, 14393);
				...
				case 3u:
					...
					continue;
				case 1u:
					bool_9 = Class171.smethod_289(0, 0, 10, 15063);
					bool_10 = Class171.smethod_289(0, 0, 10, 16299);
					num = ((int)num2 * -380392191) ^ -131118160;
					continue;
				case 0u:
					bool_5 = Class171.smethod_289(2, 0, 6, -1);
