...
public sealed class Class87 : Class85
{
	...
	public override IntPtr method_083B(string string_0)
	{
		...
		goto IL_0160;
		IL_0016:
		IntPtr intPtr = Class171.smethod_220(Class171.smethod_42(method_19())[Class178.smethod_0(8503)] ?? throw new FileNotFoundException(Class178.smethod_0(28636)), Class178.smethod_0(28709), bool_0: false);
		...
		while (true)
		{
			...
			case 10u:
				...
				continue;
			case 9u:
				intPtr2 = Class171.smethod_315(this, intPtr, intPtr3);
				num = 703462975;
				continue;
			case 5u:
			...
			case 3u:
				...
				intPtr3 = Class171.smethod_174(this, bytes.Length, Class124.Enum34.flag_6);
				num = 324879476;
				continue;
			case 2u:
