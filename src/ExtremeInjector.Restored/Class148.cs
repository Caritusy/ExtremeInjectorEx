				...
				while (true)
				{
					...
					while (true)
					{
						...
						case 9u:
							...
							continue;
						case 8u:
							num4 = string_1.LastIndexOf(Class178.smethod_0(10075), StringComparison.OrdinalIgnoreCase);
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 20u:
					...
					continue;
				case 18u:
					num4 = Class171.smethod_134(class154_0, @class.method_4());
				...
				case 10u:
					...
					continue;
				case 9u:
					gclass0_0[text].AddRange(Class171.smethod_404(text, @class.method_8(), this));
				...
				case 2u:
					...
					continue;
				case 1u:
					gclass0_0.imethod_0(text, new List<string>(Class171.smethod_404(text, @class.method_8(), this)));
					num = -784129433;
					continue;
				case 0u:
