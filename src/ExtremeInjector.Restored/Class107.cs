...
public sealed class Class107 : Class106
{
	...
	{
		Class104 @class = new Class104(Class171.smethod_218(this, 0), method_2());
		@class.method_7(method_6());
		return @class;
	}

	[SpecialName]
	public override Class103 method_05E2()
	{
		Class104 @class = new Class104(Class171.smethod_218(this, 1), method_2());
		@class.method_7(method_6());
		return @class;
	}

	[SpecialName]
	public override Class103 method_05E3()
	{
		Class104 @class = new Class104(Class171.smethod_218(this, 2), method_2());
		@class.method_7(method_6());
		return @class;
	}
	...
	{
		Class101 @class = new Class101(Class171.smethod_218(this, 11), method_2());
		@class.method_7(method_6());
		return @class;
	}

	[SpecialName]
	public override IntPtr method_05E7()
	{
