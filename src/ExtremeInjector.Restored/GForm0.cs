...
public sealed class GForm0 : Form
{
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 2u:
					{
						...
						Enum3 @enum = enum3_0;
						num = (Class171.smethod_211(ref intptr_, gForm, @enum, string_) ? (-339275510) : (-1054222856)) ^ ((int)num2 * -1439401513);
						continue;
					}
					case 1u:
	...
	public sealed class Class31
	{
		...
		internal void method_0()
		{
			MessageBox.Show(gform0_0, Class171.smethod_339(string_0, exception_0, bool_0: true), Class178.smethod_0(599), MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
		}
	}
	...
	public GForm0()
	{
				...
				while (true)
				{
					...
					while (true)
					{
						...
						case 3u:
						{
							...
							Class171.smethod_343(bool_0: true, null, bool_1: true, this, current2);
							num = -1917655493;
							continue;
						}
						case 2u:
		...
		foreach (Class16 item in Class12.class12_0.list_0)
		{
			...
			Class171.smethod_343(item.bool_0, item, bool_1: false, this, string_);
		}
	...
	internal void method_2(object sender, EventArgs e)
	{
		...
		while (true)
		{
			...
			case 8u:
				break;
			case 7u:
				num = ((Class171.smethod_153(this).Length != 0) ? 1761209380 : 970253221) ^ (int)(num2 * 945278361);
				continue;
			case 4u:
				goto IL_0042;
			case 3u:
			...
			break;
			IL_0042:
			num = ((!Class171.smethod_296(gclass2_0)) ? 922654054 : 1450742243);
		}
		goto IL_000b;
		IL_0101:
		timer_0.Stop();
		...
		try
		{
			...
			while (true)
			{
				...
				while (true)
				{
					...
					{
					case 2u:
						Class171.smethod_343(bool_0: true, null, bool_1: true, this, openFileDialog.FileName);
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 3u:
					{
						...
						Class171.smethod_343(bool_0: true, null, bool_1: true, this, current);
						num = -1917655493;
						continue;
					}
					case 2u:
